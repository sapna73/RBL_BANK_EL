...
public class CashDenominationTableDataRequestDTO {
...
//        }
    ...
    public static class SpNameWithParameterClass {
        ...
        @Expose
        private CashDenominationTable SpParameters;
        ...
        public CashDenominationTable getSpParameters() {
            return SpParameters;
        }

        public void setSpParameters(CashDenominationTable spParameters) {
