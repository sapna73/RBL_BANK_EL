...
//    @TypeConverters(DataTypeConverter.class)
    ...
    public SubmitDataDTO(int id, String BCID, String BCBRID, String projectId, String screenId,
                         String productId, String moduleId, String createdBy, JsonArray rawData,
