...
public class CenterMeetingCollectionDataRequestDTO {
...
//        }
    ...
    public static class SpNameWithParameterClass {
        ...
        @Expose
        private CenterMeetingCollectionTable SpParameters;
        ...
        public CenterMeetingCollectionTable getSpParameters() {
            return SpParameters;
        }

        public void setSpParameters(CenterMeetingCollectionTable spParameters) {
