...
import static com.swadhaar.los.constants.AppConstant.BCID;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_LEAD_NAME_STATE_NAME;
 ...
 * Use the {@link ApplicantRegulatoryFields#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ApplicantRegulatoryFields extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    private static final String TAG = ApplicantRegulatoryFields.class.getCanonicalName();

    private ApplicantRegulatoryFields.OnFragmentInteractionListener mListener;
    String leadState = "";

    public ApplicantRegulatoryFields() {

    }

    // TODO: Rename and change types and number of parameters
    public static ApplicantRegulatoryFields newInstance(String loanType, String clientId, String projectId, String productId,
                                                        String screenNo, String screenName, String userId, String moduleType) {
        ApplicantRegulatoryFields fragment = new ApplicantRegulatoryFields();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(ApplicantRegulatoryFields.this);
    }
