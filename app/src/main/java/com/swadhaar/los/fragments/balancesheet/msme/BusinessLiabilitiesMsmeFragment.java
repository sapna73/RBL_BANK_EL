package com.swadhaar.los.fragments.balancesheet.msme;
...
public class BusinessLiabilitiesMsmeFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private OnFragmentInteractionListener mListener;

    public BusinessLiabilitiesMsmeFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static BusinessLiabilitiesMsmeFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                              String screenNo, String screenName, String userId, String moduleType) {
        BusinessLiabilitiesMsmeFragment fragment = new BusinessLiabilitiesMsmeFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(BusinessLiabilitiesMsmeFragment.this);
        ...
        Observer observer=new Observer() {
            ...
            public void onChanged(@Nullable Object o) {
                ...
                if(list.size()>0) {
                    ...
                    businessLiabilitiesMsmeCalculation(list.get(list.size()-1),list);
                }else{
                    updateUI(list);
                }
