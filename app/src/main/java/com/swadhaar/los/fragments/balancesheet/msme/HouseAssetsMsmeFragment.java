...
public class HouseAssetsMsmeFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private OnFragmentInteractionListener mListener;

    public HouseAssetsMsmeFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static HouseAssetsMsmeFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                      String screenNo, String screenName, String userId, String moduleType) {
        HouseAssetsMsmeFragment fragment = new HouseAssetsMsmeFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(HouseAssetsMsmeFragment.this);
    ...
    public void configureViewModel(){
        ...
        Observer observer=new Observer() {
            ...
            public void onChanged(@Nullable Object o) {
                ...
                if(list.size()>0) {
                    houseAssetCalculation(list.get(list.size()-1),list);
                }else{
                    updateUI(list);
                }
