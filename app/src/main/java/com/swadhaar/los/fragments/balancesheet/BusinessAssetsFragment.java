...
public class BusinessAssetsFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    private static final String TAG = BusinessAssetsFragment.class.getCanonicalName() ;
    ...
    public BusinessAssetsFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static BusinessAssetsFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                   String screenNo,String screenName,String userId,String moduleType) {
        BusinessAssetsFragment fragment = new BusinessAssetsFragment();
...
//        return inflater.inflate(R.layout.fragment_common_layout, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(BusinessAssetsFragment.this);
...
//                    getRawDataForParentFragment(SCREEN_NAME,list);
                    businessAssetILCalculation(list.get(list.size()-1),list);
                }else{
                    updateUI(list);
                }
            }
