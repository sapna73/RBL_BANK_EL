...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_RE_ENTER_KYC_ID;
...
public class ApplicantKYCFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    ...
    public ApplicantKYCFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static ApplicantKYCFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                   String screenNo, String screenName, String userId, String moduleType) {
        ApplicantKYCFragment fragment = new ApplicantKYCFragment();
...
//                getTagNameList(SCREEN_NAME,list,TAG_NAME_ADD_ANOTHER_KYC_PLUS_BUTTON);
                if(list !=null && list.size()>0) {
                    if(LOAN_TYPE.equalsIgnoreCase(LOAN_NAME_JLG)){
                        CenterCreationTable  CENTER_CREATION_TABLE = null;
                        if(getActivity() !=null && getActivity().getIntent() !=null) {
                            String centerJsonString = getActivity().getIntent().getStringExtra(PARAM_CENTER_TABLE_JSON);
