...
public class CoApplicantRegulatoryFields extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    ...
    public CoApplicantRegulatoryFields() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(CoApplicantRegulatoryFields.this);
    }
