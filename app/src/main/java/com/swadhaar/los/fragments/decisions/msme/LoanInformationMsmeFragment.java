...
public class LoanInformationMsmeFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    OnFragmentInteractionListener mListener;


    public LoanInformationMsmeFragment() {
    }

    // TODO: Rename and change types and number of parameters
    public static LoanInformationMsmeFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                          String screenNo,String screenName,String userId,String moduleType) {
        LoanInformationMsmeFragment fragment = new LoanInformationMsmeFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(LoanInformationMsmeFragment.this);
