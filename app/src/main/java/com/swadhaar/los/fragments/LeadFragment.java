...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_LEAD_TYPE;
                            ...
                            if( ! TextUtils.isEmpty(dynamicUITable.getFieldTag())){
                               if( hashMap.containsKey(dynamicUITable.getFieldTag()) ) {
                                   ...
                                   if (!TextUtils.isEmpty(value)) {
                                       ...
                                       if(
                                       dynamicUITable.getFieldTag().equalsIgnoreCase(TAG_NAME_MOBILE_NUMBER)
