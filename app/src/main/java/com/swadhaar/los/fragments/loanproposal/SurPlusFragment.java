package com.swadhaar.los.fragments.loanproposal;
 ...
 * {@link SurPlusFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SurPlusFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SurPlusFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    private static final String TAG = SurPlusFragment.class.getCanonicalName() ;
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private OnFragmentInteractionListener mListener;

    public SurPlusFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static SurPlusFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                   String screenNo,String screenName,String userId,String moduleType) {
        SurPlusFragment fragment = new SurPlusFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(SurPlusFragment.this);
    }
                    ...
                    public void onChanged(@Nullable Object o) {
                        ...
                        if(rawDataTableList !=null && rawDataTableList.size()>0){
                            ...
                            if(hashMapList !=null && hashMapList.size()>0){
                                ...
                                // TODO: Fresh Data
//                                updateUI(list);
                                calculateSurplus(list.get(0),list);
                            }
                        }else{
                            // TODO: Fresh Data
//                            updateUI(list);
    ...
    private void calculateSurplus(DynamicUITable dynamicUITable, List<DynamicUITable> dynamicUITableList) {
        try {
            viewModel.calculateSurplus(  dynamicUITable, dynamicUITableList);
