package com.swadhaar.los.fragments.balancesheet;
...
public class HouseLiabilitiesFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    private static final String TAG = HouseLiabilitiesFragment.class.getCanonicalName();
    ...
    public HouseLiabilitiesFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static HouseLiabilitiesFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                   String screenNo,String screenName,String userId,String moduleType) {
        HouseLiabilitiesFragment fragment = new HouseLiabilitiesFragment();
...
//        return inflater.inflate(R.layout.fragment_common_layout, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(HouseLiabilitiesFragment.this);
...
//                    getRawDataForParentFragment(SCREEN_NAME,list);
                    houseLiabilitiesILCalculation(list.get(list.size()-1),list);
                }else{
                    updateUI(list);
                }
