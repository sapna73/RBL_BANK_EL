...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.FIELD_NAME_ADD_ANOTHER_REFERENCE;
 ...
 * {@link ReferenceCheckFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ReferenceCheckFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ReferenceCheckFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    private static final String TAG = ReferenceCheckFragment.class.getCanonicalName();
    ...
    public ReferenceCheckFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static ReferenceCheckFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                     String screenNo, String screenName, String userId, String moduleType) {
        ReferenceCheckFragment fragment = new ReferenceCheckFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(ReferenceCheckFragment.this);
    }
...
//                getTagNameList(SCREEN_NAME, list, FIELD_NAME_ADD_ANOTHER_REFERENCE);
                    if(list !=null && list.size()>0) {
                        referenceCheckScreenValidation(list.get(0),list);
                    }
                }
//            }
            };
