package com.swadhaar.los.fragments.decisions;
 ...
 */
public class ObservationsFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    private static final String TAG = ObservationsFragment.class.getCanonicalName() ;
    ...
    public static ObservationsFragment newInstance(String loanType, String clientId, String projectId, String productId,
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(ObservationsFragment.this);
    }
