...
public class ServiceEstimateFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private OnFragmentInteractionListener mListener;

    public ServiceEstimateFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static ServiceEstimateFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                      String screenNo, String screenName, String userId, String moduleType) {
        ServiceEstimateFragment fragment = new ServiceEstimateFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(ServiceEstimateFragment.this);
    ...
    public void fragmentBecameVisible() {
        ...
        Observer observer=new Observer() {
            ...
            public void onChanged(@Nullable Object o) {
                ...
                if(list.size()>0) {
                    ServiceEstimateCalculation(list.get(list.size()-1),list);
                }else{
                    updateUI(list);
                }
