...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_ADDRESS_LINE_1;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_ADDRESS_LINE_2;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_ADDRESS_SAME_AS_KYC;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_CITY;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_DISTRICT;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_KYC_ID;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_LANDMARK;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_PINCODE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_COMMUNICATION_STATE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_SAVE_BUTTON;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link CoApplicantAddressDetailFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link CoApplicantAddressDetailFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CoApplicantAddressDetailFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    private static final String TAG =CoApplicantAddressDetailFragment.class.getCanonicalName() ;
    ...
    public CoApplicantAddressDetailFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static CoApplicantAddressDetailFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                   String screenNo, String screenName, String userId, String moduleType) {
        CoApplicantAddressDetailFragment fragment = new CoApplicantAddressDetailFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_co_applicant_address_detail, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(CoApplicantAddressDetailFragment.this);
    }
                    ...
                    public void onChanged(@Nullable Object o) {
                        ...
                        if(rawDataTableList !=null && rawDataTableList.size()>0){
                            ...
                            if(hashMapList !=null && hashMapList.size()>0){
                                        ...
                                        if( ! TextUtils.isEmpty(dynamicUITable.getFieldTag())){
                                            if( hashMap.containsKey(dynamicUITable.getFieldTag()) ) {
                                                ...
                                                if (!TextUtils.isEmpty(value)) {
                                                    ...
                                                    if (hashMap.containsKey(TAG_NAME_COMMUNICATION_ADDRESS_SAME_AS_KYC)) {
                                                        String valuepkyc = hashMap.get(TAG_NAME_COMMUNICATION_ADDRESS_SAME_AS_KYC).toString();

                                                        if (valuepkyc.equalsIgnoreCase("Yes")) {

                                                            if (dynamicUITable.getFieldTag().equalsIgnoreCase(TAG_NAME_COMMUNICATION_ADDRESS_LINE_1) ||
                                                                    dynamicUITable.getFieldName().equalsIgnoreCase(TAG_NAME_COMMUNICATION_KYC_ID) ||
                                ...
                                // TODO: Fresh Data
//                                updateUI(list);
                                //getFullName(screen,SCREEN_NAME_CO_APPLICANT_KYC,SCREEN_NAME_COAPPLICANT_ADDRESS_DETAIL,CLIENT_ID,MODULE_TYPE);
