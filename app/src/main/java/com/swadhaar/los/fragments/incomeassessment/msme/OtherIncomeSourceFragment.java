package com.swadhaar.los.fragments.incomeassessment.msme;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_SAVE_AND_ADD_INCOME_DETAIL;


public class OtherIncomeSourceFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private OnFragmentInteractionListener mListener;

    public OtherIncomeSourceFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static OtherIncomeSourceFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                        String screenNo, String screenName, String userId, String moduleType) {
        OtherIncomeSourceFragment fragment = new OtherIncomeSourceFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(OtherIncomeSourceFragment.this);
...
//                    getTagNameList(SCREEN_NAME,list, TAG_NAME_SAVE_AND_ADD_INCOME_DETAIL);
                    if(list !=null && list.size()>0) {
                        otherIncomeSourceScreenValidation(list.get(0),list);
                    }
                }else{
                    updateUI(list);
                }
