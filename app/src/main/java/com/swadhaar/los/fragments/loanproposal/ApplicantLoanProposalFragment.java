...
public class ApplicantLoanProposalFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector , FragmentInterface {
    private static final String TAG = ApplicantLoanProposalFragment.class.getCanonicalName() ;
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private OnFragmentInteractionListener mListener;

    public ApplicantLoanProposalFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static ApplicantLoanProposalFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                            String screenNo, String screenName, String userId, String moduleType) {
        ApplicantLoanProposalFragment fragment = new ApplicantLoanProposalFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(ApplicantLoanProposalFragment.this);
    }
...
*/
    ...
    public void configureViewModel() {
        ...
        else if(LOAN_TYPE.equalsIgnoreCase(LOAN_NAME_PHL)){ // TODO: PHL product master
//            init();
            getProductMasterFromServer(PRODUCT_ID, AppConstant.BCID_PHL); // TODO: BCID PHL is static value
        }
        else if(LOAN_TYPE.equalsIgnoreCase(LOAN_NAME_AHL)){ // TODO: AHL product master
//            init();
