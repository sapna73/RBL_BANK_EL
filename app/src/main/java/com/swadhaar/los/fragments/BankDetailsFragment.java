 ...
 */
public class BankDetailsFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    private static final String TAG = BankDetailsFragment.class.getCanonicalName();
    ...
    public static BankDetailsFragment newInstance(String loanType, String clientId, String projectId, String productId,
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(BankDetailsFragment.this);
    }
...
//                    getRawDataForParentFragment(SCREEN_NAME, list);
                    ...
                    if(!TextUtils.isEmpty(LOAN_TYPE) && (LOAN_TYPE.equalsIgnoreCase(LOAN_NAME_MSME)||LOAN_TYPE.equalsIgnoreCase(LOAN_NAME_AHL)||LOAN_TYPE.equalsIgnoreCase(LOAN_NAME_PHL))) {
