...
public class SubjectToConditionsMsmeFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    OnFragmentInteractionListener mListener;
    public SubjectToConditionsMsmeFragment() {
    }

    // TODO: Rename and change types and number of parameters
    public static SubjectToConditionsMsmeFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                          String screenNo,String screenName,String userId,String moduleType) {
        SubjectToConditionsMsmeFragment fragment = new SubjectToConditionsMsmeFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(SubjectToConditionsMsmeFragment.this);
    }
