...
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_MANUFACTURING_DECALRED_SALES_WEEKLY;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_MANUFACTURING_OPERATING_EXPENSE;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_MANUFACTURING_PURCHASE_ANALYSIS;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_AVERAGE_WEEKLY_SALES;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_AVERGAE_MONTHLY_SALES_FOR_DAILY;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_BY_DAILY_WEEKLY_FIGURES;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_BY_FREQUENCY;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_BY_MONTHLY_FIGURES;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_EXPENSES;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_MONTHLY_PURCHASE_FREQUENCY;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_OPERATION_EXPENSE;


public class SummaryFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    ...
    public static SummaryFragment newInstance(String loanType, String clientId, String projectId, String productId,
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(SummaryFragment.this);
...
//                copyValuesFromOtherScreen(list);
    ...
    private void copyValuesFromOtherScreen(List<DynamicUITable> dynamicUITableList){
        ...
        fromScreenList.add(new ParameterInfo(TAG_NAME_AVERAGE_WEEKLY_SALES, SCREEN_N0_MANUFACTURING_DECALRED_SALES_WEEKLY, "", true, true));
        fromScreenList.add(new ParameterInfo(TAG_NAME_AVERGAE_MONTHLY_SALES_FOR_DAILY, SCREEN_N0_MANUFACTURING_DECALRED_SALES_WEEKLY, "", true, true));
        fromScreenList.add(new ParameterInfo(TAG_NAME_MONTHLY_PURCHASE_FREQUENCY, SCREEN_N0_MANUFACTURING_PURCHASE_ANALYSIS, "", true, true));
        fromScreenList.add(new ParameterInfo(TAG_NAME_EXPENSES, SCREEN_N0_MANUFACTURING_OPERATING_EXPENSE, "", true, true));

        List<ParameterInfo> toScreenList = new ArrayList<>();
        toScreenList.add(new ParameterInfo(TAG_NAME_BY_DAILY_WEEKLY_FIGURES, SCREEN_ID, "", true, false));
        toScreenList.add(new ParameterInfo(TAG_NAME_BY_MONTHLY_FIGURES, SCREEN_ID, "", true, false));
        toScreenList.add(new ParameterInfo(TAG_NAME_BY_FREQUENCY, SCREEN_ID, "", true, false));
        toScreenList.add(new ParameterInfo(TAG_NAME_OPERATION_EXPENSE, SCREEN_ID, "", true, false));
