...
public class BusinessLiabilitiesFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private OnFragmentInteractionListener mListener;

    public BusinessLiabilitiesFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static BusinessLiabilitiesFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                   String screenNo,String screenName,String userId,String moduleType) {
        BusinessLiabilitiesFragment fragment = new BusinessLiabilitiesFragment();
...
//        return inflater.inflate(R.layout.fragment_common_layout, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(BusinessLiabilitiesFragment.this);
...
//                    getRawDataForParentFragment(SCREEN_NAME,list);
                    businessLiabilitiesILCalculation(list.get(list.size()-1),list);
                }else{
                    updateUI(list);
                }
            }
