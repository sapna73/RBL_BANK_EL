...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_SAVE_AND_ADD_GENERAL_INCOME;


public class GeneralIncomeFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER

    private OnFragmentInteractionListener mListener;

    public GeneralIncomeFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static GeneralIncomeFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                    String screenNo, String screenName, String userId, String moduleType) {
        GeneralIncomeFragment fragment = new GeneralIncomeFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(GeneralIncomeFragment.this);
    }
...
//                    getTagNameList(SCREEN_NAME,list, TAG_NAME_SAVE_AND_ADD_GENERAL_INCOME);
                    if(list !=null && list.size()>0) {
                        generalIncomeScreenValidation(list.get(0),list);
                    }
                }else{
                    updateUI(list);
                }
