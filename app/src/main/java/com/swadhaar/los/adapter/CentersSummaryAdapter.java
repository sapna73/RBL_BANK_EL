...
public class CentersSummaryAdapter extends RecyclerView.Adapter<CentersSummaryAdapter.LoanTypeViewHolder> implements Filterable {
    ...
    public CentersSummaryAdapter(Context context, List<CenterCreationTable> centerCreationTableList,
    ...
    public LoanTypeViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.center_summary_row_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull LoanTypeViewHolder loanTypeViewHolder, int i) {
        try {
            if (centerCreationTableListFiltered != null && centerCreationTableListFiltered.size() > 0) {
                ...
                loanTypeViewHolder.tvNoOfCustomers.setText(String.valueOf(centerCreationTable.getNoOfMembers()));
