...
import com.swadhaar.los.activities.LOPricingActivity;
import com.swadhaar.los.activities.LeadToPricingActivity;
import com.swadhaar.los.database.entity.MasterTable;
import com.swadhaar.los.models.CibilUpStreamDownStreamModel;

import java.util.ArrayList;
import java.util.List;

public class OtherThenLOLeadPriceingAdapter extends RecyclerView.Adapter<OtherThenLOLeadPriceingAdapter.LoanTypeViewHolder> implements Filterable {

    private Context context;
    List<MasterTable> masterTableList;
    List<MasterTable> masterTableListFiltered;
    OtherThenLOLeadPriceingAdapter.SyncCallbackInterface syncCallbackInterface;
    AppHelper appHelper;
    CibilUpStreamDownStreamModel cibilUpStreamDownStreamModelList;

    public OtherThenLOLeadPriceingAdapter(Context context, List<MasterTable> masterTableList,
                                OtherThenLOLeadPriceingAdapter.SyncCallbackInterface syncCallbackInterface, AppHelper appHelper) {
    ...
    @NonNull
    @Override
    public OtherThenLOLeadPriceingAdapter.LoanTypeViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lead_to_priceing_row_item, viewGroup, false);
        return new OtherThenLOLeadPriceingAdapter.LoanTypeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OtherThenLOLeadPriceingAdapter.LoanTypeViewHolder loanTypeViewHolder, int i) {
        try {
            if (masterTableListFiltered != null && masterTableListFiltered.size() > 0) {
                ...
                loanTypeViewHolder.btnPriceIng.setOnClickListener(new View.OnClickListener() {
                    @Override
                ...
                loanTypeViewHolder.llLeadDetails.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        application.putExtra(PARAM_USER_NAME, leadToPricingActivity.userName);
    ...
    public class LoanTypeViewHolder extends RecyclerView.ViewHolder {
        ...
        public Button btnPriceIng, btnReject;
        ...
        public LoanTypeViewHolder(@NonNull View itemView) {
            ...
            btnPriceIng = (Button) itemView.findViewById(R.id.btnPriceIng);
        }
    }
