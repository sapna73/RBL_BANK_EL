...
public class MemberDetailsAdapter extends RecyclerView.Adapter<MemberDetailsAdapter.ClientDetailsViewHolder> {
    Context context;
    ...
    public MemberDetailsAdapter(Context context, List<RawDataTable> rawDataTableList,
