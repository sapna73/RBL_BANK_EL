...
import static com.swadhaar.los.constants.AppConstant.PARAM_AUTO_FILL;
...
import static com.swadhaar.los.constants.AppConstant.PARAM_HASH_MAP;
...
public class LeadDetailsAdapter extends RecyclerView.Adapter<LeadDetailsAdapter.LoanTypeViewHolder> implements Filterable {
    ...
    public LeadDetailsAdapter(Context context, ArrayList<HashMap<String, Object>> leadDetailsDTOList, List<RawDataTable> rawDataTableList,
            ...
            if (leadDetailsDTOListFiltered != null && leadDetailsDTOListFiltered.size() > 0) {
                ...
                if (leadDetailsDTOListFiltered.get(i).containsKey(TAG_NAME_INTERESTED_IN_LOAN)) {
                    if (leadDetailsDTOListFiltered.get(i).get(TAG_NAME_INTERESTED_IN_LOAN).toString().equalsIgnoreCase("Yes")) {
                        loanTypeViewHolder.ivStatus.setVisibility(View.VISIBLE); // TODO: Need to remove for lead
                        ...
                        loanTypeViewHolder.ivStatus.setVisibility(View.INVISIBLE); // TODO: Need to remove for lead
...
//                    if(rawDataTable !=null && ! rawDataTable.isSync()) {
                        ...
                        intentApplication.putExtra(PARAM_USER_ID, rawDataTable.getUser_id());
...
//            ivLoanIcon=(ImageView)itemView.findViewById(R.id.iv_loan_icon);
            ...
            cvLead = itemView.findViewById(R.id.cv_lead);
