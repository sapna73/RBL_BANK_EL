...
import com.swadhaar.los.adapter.ApplicationToPDAdapter;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.CURRENT_STAGE_PD;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.FIELD_NAME_SAVE_AND_ADD_ANOTHER_KYC;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.FINAL_STATUS_SEND_BACK;
            ...
            if (!TextUtils.isEmpty(table.getRwas())) {
                ...
                if(screenDetailsDTO !=null && ! TextUtils.isEmpty(screenDetailsDTO.getScreenName())) {
                    ...
                    viewModel.init(screenDetailsDTO.getScreenId(), screenDetailsDTO.getScreenName(),
                            loanType, PROJECT_ID_LOS, productId, table.getCustomerId(), userId, screenDetailsDTO.getModuleType());
                    Observer observer = new Observer() {
                        @Override
                        public void onChanged(@Nullable Object o) {
