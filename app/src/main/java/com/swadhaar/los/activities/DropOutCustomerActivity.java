...
import com.swadhaar.los.adapter.DropOutCustomerAdapter;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.ERROR_MESSAGE_CUSTOMER_DROPPED_OUT;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.ERROR_MESSAGE_DATA_SAVED_SUCCESSFULLY;

public class DropOutCustomerActivity extends LOSBaseActivity {

    private static final String TAG = DropOutCustomerActivity.class.getCanonicalName();
    RecyclerView rvLeadDetails;
    SearchView searchByPhoneNo;
    DropOutCustomerAdapter dropOutCustomerAdapter;
...
//    TextView tvStaffId, tvStaffName, tvSOBDate;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drop_out_customer);
        ...
        dropOutCustomerAdapter = new DropOutCustomerAdapter(DropOutCustomerActivity.this, new ArrayList<>(),
                appHelper);
        rvLeadDetails.setAdapter(dropOutCustomerAdapter);
        ...
        searchByPhoneNo.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (dropOutCustomerAdapter != null && dropOutCustomerAdapter.getFilter() != null) {
                    dropOutCustomerAdapter.getFilter().filter(query);
                }
                return false;
            }
        ...
        btnSaveAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(dropOutCustomerAdapter !=null && dropOutCustomerAdapter.getCgtTableList() !=null
                        && dropOutCustomerAdapter.getCgtTableList().size()>0){
                    List<CGTTable> cgtTableList=new ArrayList<>();
                    for(CGTTable cgtTable : dropOutCustomerAdapter.getCgtTableList()){
                        if(cgtTable.isDropOutCustomer()){
                            cgtTableList.add(cgtTable);
                        }
                    }

                    if(cgtTableList.size()>0) {
                        deleteDropOutCustomers(cgtTableList);
                    }
    ...
    private void deleteDropOutCustomers(List<CGTTable> cgtTableList) {
        try{
            viewModel.deleteDropOutCustomers(cgtTableList);
                ...
                Observer observer = new Observer() {
                    ...
                    public void onChanged(@Nullable Object o) {
                        appHelper.getDialogHelper().getConfirmationDialog().show(ConfirmationDialog.SUCCESS,
                                ERROR_MESSAGE_CUSTOMER_DROPPED_OUT, new ConfirmationDialog.ActionCallback() {
                                    @Override
        ...
        try {
            ...
            if (!TextUtils.isEmpty(centerJsonString)) {
                ...
                if (CENTER_CREATION_TABLE != null) {
                    ...
                    getCGTTableForDropOut(CENTER_CREATION_TABLE);
                }
            }
    ...
    public void getCGTTableForDropOut(CenterCreationTable centerCreationTable) {
        ...
        try {
            viewModel.getCGTTableForDropOut(centerCreationTable);
            if (viewModel.getCgtTableLiveDataList() != null) {
                Observer observer = new Observer() {
                    @Override
                    public void onChanged(@Nullable Object o) {
                        ...
                        if (cgtTableList != null && cgtTableList.size() > 0) {
                            ...
                            if (dropOutCustomerAdapter != null) {
                                dropOutCustomerAdapter.setItem(cgtTableList);
                            }
