...
import com.swadhaar.los.adapter.CenterMeetingODCollectionAdapter;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.ERROR_MESSAGE_COLLECTION_FAILED;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.ERROR_MESSAGE_DO_YOU_WANT_TO_PROCEED;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.COLLECTION_TYPE_OD;

public class CenterMeetingODCollectionActivity extends LOSBaseActivity {

    private static final String TAG = CenterMeetingODCollectionActivity.class.getCanonicalName();
    RecyclerView rvLeadDetails;
    CenterMeetingODCollectionAdapter centerMeetingODCollectionAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_center_meeting_od_collection);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                insertStaffActivity(viewModel,CENTER_NAME,userId,"OD COLLECTION",1);
        ...
        centerMeetingODCollectionAdapter = new CenterMeetingODCollectionAdapter(CenterMeetingODCollectionActivity.this,
                new ArrayList<>(),appHelper,
                viewModel,CENTER_NAME,true);
        rvLeadDetails.setAdapter(centerMeetingODCollectionAdapter);

        btnProceed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(centerMeetingODCollectionAdapter !=null && centerMeetingODCollectionAdapter.getGroupList() !=null
                        && centerMeetingODCollectionAdapter.getGroupList().size()>0){
    ...
    private void saveCenterMeetingCollection() {
        try{
            viewModel.saveCenterMeetingCollection(CENTER_NAME, COLLECTION_TYPE_OD);
        ...
        // TODO: Insert Into Staff Activity Table
        insertStaffActivity(viewModel,CENTER_NAME,userId,"OD COLLECTION",0);
    }
...
//            viewModel.getCashCollectionSummaryList(userId,cmDate);
            viewModel.getCashCollectionSummaryListByCollectionType(userId,cmDate, COLLECTION_TYPE_OD,CENTER_NAME);
                ...
                Observer observer = new Observer() {
                    ...
                    public void onChanged(@Nullable Object o) {
                        ...
                        if(cashCollectionSummaryDTO !=null && cashCollectionSummaryDTO.getIndividualCenterCollectionList() !=null
                            ...
                            // TODO: Setting isEditable
                            btnProceed.setEnabled(isEditable);
    ...
    // TODO: GETTING GROUP LIST FOR OD COLLECTION
...
//            viewModel.getGroupListForCollectionByCollectionType(userId,centerName, COLLECTION_TYPE_OD);
                ...
                Observer observer = new Observer() {
                    ...
                    public void onChanged(@Nullable Object o) {
                        ...
                        if(groupList !=null && groupList.size()>0){
                            ...
                            if (centerMeetingODCollectionAdapter != null) {
                                centerMeetingODCollectionAdapter.setItem(groupList);
                            }
