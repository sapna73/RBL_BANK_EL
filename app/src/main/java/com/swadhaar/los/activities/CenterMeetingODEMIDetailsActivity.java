...
import com.swadhaar.los.adapter.CenterMeetingODEMIDetailsAdapter;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.ERROR_MESSAGE_EMI_DETAILS_SAVED_SUCCESSFULLY;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.ERROR_MESSAGE_SELECT_ARREAR_REASON;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.JLG_MINIMUM_OVERDUE_COLLECTION;

public class CenterMeetingODEMIDetailsActivity extends LOSBaseActivity implements CenterMeetingODEMIDetailsAdapter.EMIDetailsCallBackInterface {

    private static final String TAG = CenterMeetingODEMIDetailsActivity.class.getCanonicalName();
    RecyclerView rvLeadDetails;
    CenterMeetingODEMIDetailsAdapter centerMeetingODEMIDetailsAdapter;
    ...
    TextView tvClientName,tvClientId,tvTotalEMI,tvTotalDue,tvTotalCollection,tvPDPDate;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_center_meeting_od_emi_details);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                insertStaffActivity(viewModel,CENTER_NAME,userId,"OD EMI DETAILS",1);
...
//        }
        ...
        centerMeetingODEMIDetailsAdapter = new CenterMeetingODEMIDetailsAdapter(CenterMeetingODEMIDetailsActivity.this, new ArrayList<>(),appHelper,
                this::totalCollectionCallBack);
        rvLeadDetails.setAdapter(centerMeetingODEMIDetailsAdapter);

        btnProceed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(centerMeetingODEMIDetailsAdapter !=null && centerMeetingODEMIDetailsAdapter.getEmiDetailsDTOList() !=null
                        && centerMeetingODEMIDetailsAdapter.getEmiDetailsDTOList().size()>0){

                    boolean isValidMinAmt=false;
                    for(EMIDetailsDTO emiDetailsDTO : centerMeetingODEMIDetailsAdapter.getEmiDetailsDTOList()){
                        int collection=emiDetailsDTO.getCollection();
                        if(collection >JLG_MINIMUM_OVERDUE_COLLECTION ){
                            isValidMinAmt=true;
                        }
                       ...
                       if(isValidMaxAmt) {
                           ...
                           appHelper.getDialogHelper().getConfirmationDialog().showTwoButtons(ERROR_MESSAGE_DO_YOU_WANT_TO_PROCEED, new ConfirmationDialog.ActionCallback() {
                               ...
                               public void onAction() {
                                   saveEMIDetailsCenterMeetingCollection(centerMeetingODEMIDetailsAdapter.getEmiDetailsDTOList());
                               }
                           });
                       }else{
        ...
        cbPaidByOther.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(centerMeetingODEMIDetailsAdapter.getEmiDetailsDTOList() !=null
                        && centerMeetingODEMIDetailsAdapter.getEmiDetailsDTOList().size()>0){
        ...
        ibPDPDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog=new DatePickerDialog(CenterMeetingODEMIDetailsActivity.this,
        ...
        // TODO: Insert Into Staff Activity Table
        insertStaffActivity(viewModel,CENTER_NAME,userId,"OD EMI DETAILS",0);
    }
                ...
                Observer observer = new Observer() {
                    ...
                    public void onChanged(@Nullable Object o) {
                        ...
                        if(emiDetailsDTOList !=null && emiDetailsDTOList.size()>0){
                            ...
                            if (centerMeetingODEMIDetailsAdapter != null) {
                                centerMeetingODEMIDetailsAdapter.setItem(emiDetailsDTOList);
                            }
