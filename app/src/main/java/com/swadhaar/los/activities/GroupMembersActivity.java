...
import com.swadhaar.los.adapter.GroupMemberAdapter;
...
import com.swadhaar.los.helper.Tools;
...
//                AddMembers();
    ...
    private void AddMembers() {
        try {
            ...
            if(masterTableList !=null && masterTableList.size()>0){
                viewModel.AddMembersInGroupTable(masterTableList,GROUP_NAME,CLIENT_ID); // TODO: Group name & group id
