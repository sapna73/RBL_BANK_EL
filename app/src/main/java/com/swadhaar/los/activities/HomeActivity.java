...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.EXTENSION_PDF;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.PLANNER_PURPOSE_APPLICATION;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.PLANNER_PURPOSE_COLD_CALLING;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.PLANNER_PURPOSE_LEAD_GENERATION;
...
public class HomeActivity extends LOSBaseActivity implements View.OnClickListener {
    ...
    LinearLayout llColdCalling,llLead, llSalesTool, llApplication, llPD, llVillageSurvey, llCenterCreation, llTargetDetails,llLoanApplication,
            llEligibility, llCGT,llAddorRemove,llDropOutCustomer, llGRT,llReminder;
    TextView tvLoanType;
    CardView cv_cold_calling, cv_lead, cv_sales_tool, cv_application, cv_pd, cv_village_survey, cv_center_creation, cv_targe_details, cv_loan_application,
            cv_eligibility,cv_add_or_remove,cv_drop_out_customer, cv_cgt, cv_grt,cv_reminder;
        ...
        if ( ! TextUtils.isEmpty(roleName) && roleName.equalsIgnoreCase(ROLE_NAME_BCM)) {
            ...
            if (!TextUtils.isEmpty(loanType) && loanType.equalsIgnoreCase(LOAN_NAME_JLG)) {
                ...
                // TODO: phl loan type validation
                    ...
                    cv_reminder.setVisibility(View.VISIBLE);
                }
                cv_pd.setVisibility(View.GONE);
                cv_lead.setVisibility(View.VISIBLE);
                cv_application.setVisibility(View.VISIBLE);
                cv_workflow_history.setVisibility(View.VISIBLE);
                cv_village_survey.setVisibility(View.GONE);
                cv_center_creation.setVisibility(View.GONE);
                cv_targe_details.setVisibility(View.GONE);
                cv_loan_application.setVisibility(View.GONE);
...
//                    checkPlannerStatus(userId, PLANNER_PURPOSE_LEAD_GENERATION);
                    ...
                    if (!TextUtils.isEmpty(loanType) && (loanType.equalsIgnoreCase(LOAN_NAME_MSME) || loanType.equalsIgnoreCase(LOAN_NAME_AHL) || loanType.equalsIgnoreCase(LOAN_NAME_PHL))) {
