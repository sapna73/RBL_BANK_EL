...
import static com.swadhaar.los.constants.AppConstant.PARAM_REQUEST_FROM_SAARTHI_APP;
...
import static com.swadhaar.los.constants.AppConstant.RESET_PASSWORD_TOKEN;
...
//        loanTypeDtoList.add(new LoanTypeDto("JLG", R.drawable.jlg_));
        ...
        LoanTypeAdapter loanTypeAdapter = new LoanTypeAdapter(LOSProductActivity.this, loanTypeDtoList, this);
