...
import com.swadhaar.los.dynamicui.services.DynamicUIApiInterface;
...
import static com.swadhaar.los.constants.AppConstant.PRODUCT_ID_IL;
import static com.swadhaar.los.constants.AppConstant.PRODUCT_ID_MSME;
import static com.swadhaar.los.constants.AppConstant.PROJECT_ID_LOS;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_ACCOUNT_PAYABLE_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_ADVANCES;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_ADVANCES_DEBTS_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_BUSINESS_DEBTS;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_BUSINESS_DEBTS_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_DEBTS_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_DECISIONS_HYPOTHECATION_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_DIRECT_BUSINESS_EXPENSE_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_EMPLOYER_VERIFICATION;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_FAMILY_MEMBER_INCOME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_GENERAL_INCOME_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_ITR_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_LIABILITIES;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_MONTHLY_TRANSACTION_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_OTHER_INCOME_SOURCE_MEME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_PRODUCT;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_PRODUCT_RAW_MATERIAL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_PURCHASE_BILLS_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_SALES_BILLS_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_N0_SERVICE_RAW_MATERIAL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_ADVANCE_DETAIL__MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_ADVANCES;
...
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BANK_DETAILS;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BUSINESS_ACCOUNT_PAYABLE;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BUSINESS_ASSETS;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BUSINESS_ASSETS_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BUSINESS_DEBTS;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BUSINESS_DEBTS_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BUSINESS_LIABILITIES;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BUSINESS_LIABILITIES_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_BUSINESS_PROOF;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_CO_APPLICANT_BANK_DETAILS;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_CO_APPLICANT_KYC;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_DIRECT_BUSINESS_EXPENSE_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_DIRECT_BUSINESS_EXPENSE_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_EMPLOYER_VERIFICATION;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_FAMILY_MEMBER_INCOME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_GENERAL_INCOME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_HOUSE_ASSETS_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_HOUSE_DEBTS;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_HOUSE_INCOME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_HOUSE_LIABILITIES;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_HOUSE_LIABILITIES_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_HYPOTHECATION_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_HYPOTHECATION_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_ITR_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_ITR_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_LIABILITIES;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_LOAN_APPROVAL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_LOAN_PROPOSAL;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_MONTHLY_TRANSACTION_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_MORTGAGE_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_OTHER_INCOME_SOURCE;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_PRODUCT;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_PRODUCT_ESTIMATE_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_PRODUCT_ESTIMATE_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_PRODUCT_RAW_MATERIAL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_PURCHASE_BILLS_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_PURCHASE_BILLS_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_REFERENCES;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_REFERENCE_CHECK;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_SALES_BILLS_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_SALES_BILLS_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_SALES_TOOL;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_SERVICE_ESTIMATE_DETAIL_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_SERVICE_ESTIMATE_MSME;
import static com.swadhaar.los.constants.AppConstant.SCREEN_NAME_SERVICE_RAW_MATERIAL_MSME;
import static com.swadhaar.los.constants.AppConstant.getScreenNumberForBusinessAssets;
import static com.swadhaar.los.constants.AppConstant.getScreenNumberForHouseAssets;
import static com.swadhaar.los.constants.AppConstant.getScreenNumberForMortgageFixedAssets;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.FIELD_TYPE_NEW_LIABILITY;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.FIELD_TYPE_NEW_ROW;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.RADIO_BUTTON_ITEM_MANUFACTURING;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.RADIO_BUTTON_ITEM_SERVICE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.RADIO_BUTTON_ITEM_TRADE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_AGRICULTURE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_HOUSEWIFE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_HOUSE_WIFE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_LIVESTOCK;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_MANUFACTURE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_NON_WORKING;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_NOT_WORKING;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_PENSIONER;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_SALARIED;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_SELF_EMPLOYED;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_SERVICE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_STUDENT;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_TRADE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_ACCOUNT_NUMBER;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_BANK_NAME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_BUSINESS_ID;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_BUSINESS_SUB_SECTOR;
...
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_KYC_ID;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_KYC_TYPE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_LOAN_REQUESTED_AMOUNT;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_MONTHLY_INCOME_IN_GENERAL_INCOME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_MONTHLY_INCOME_IN_OTHER_INCOME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_NAME_IN_GENERAL_INCOME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_NAME_IN_OTHER_INCOME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_OCCUPATION;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_REFERENCE_TYPE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_REFERRAL_INFO;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_TOTAL_MONTHLY_SALES_IN_LOAN_APPROVAL_MSME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_TYPE_OF_BUSINESS;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_VERIFIED_INCOME_IN_GENERAL_INCOME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_VERIFIED_INCOME_IN_OTHER_INCOME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_VERIFIED_IN_GENERAL_INCOME;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.TAG_NAME_VERIFIED_IN_OTHER_INCOME;
...
//        dynamicViews.add(lineSeparatorLayout);
    ...
    // TODO: TEXT VIEW LABLE FOR NEW ROW
                ...
                if(v.getTag() !=null){
                    ...
                    if(dynamicUITable !=null){
                        if (dynamicUITable.getScreenName().equalsIgnoreCase(SCREEN_NAME_HOUSE_LIABILITIES)
                            ...
                            removeAllChildFragments(ll.getId()+"");
                            initChild(LOAN_TYPE,CLIENT_ID,PROJECT_ID_LOS,PRODUCT_ID_IL,dynamicUITable.getScreenID(),
                            ...
                            removeAllChildFragments(ll.getId()+"");
                            initChild(LOAN_TYPE,CLIENT_ID,PROJECT_ID_LOS,PRODUCT_ID_MSME,dynamicUITable.getScreenID(),
                            ...
                            removeAllChildFragments(ll.getId()+"");
                            initChild(LOAN_TYPE,CLIENT_ID,PROJECT_ID_LOS,PRODUCT_ID_IL,SCREEN_N0_GENERAL_INCOME_MSME,
                            ...
                            removeAllChildFragments(ll.getId()+"");
                            initChild(LOAN_TYPE,CLIENT_ID,PROJECT_ID_LOS,PRODUCT_ID_MSME,SCREEN_N0_OTHER_INCOME_SOURCE_MEME,
                        ...
                        }else if(dynamicUITable.getScreenName().equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_MSME)
                                && dynamicUITable.getLoanType().equalsIgnoreCase(LOAN_NAME_MSME)){
                            // TODO: HOUSE ASSETS - ASSET TYPE
                            String[] stringArray=dynamicUITable.getFieldTag().split("_");
                            if( stringArray.length>0) {
                                String screenName=stringArray[0];
                                String screenNumber= getScreenNumberForHouseAssets(screenName);
                                if ( ! TextUtils.isEmpty(screenName) && ! TextUtils.isEmpty(screenNumber)) {
                                    ...
                                    initChild(LOAN_TYPE, CLIENT_ID, PROJECT_ID_LOS, PRODUCT_ID_MSME, screenNumber,
                                            screenName, dynamicUITableList, dynamicUITable, dynamicUITable.getCoRelationID());
                                }
                            }
                        }else if(dynamicUITable.getScreenName().equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_MSME)
                                && dynamicUITable.getLoanType().equalsIgnoreCase(LOAN_NAME_MSME)){
                            // TODO: BUSINESS ASSETS - ASSET TYPE
                            String[] stringArray=dynamicUITable.getFieldTag().split("_");
                            if( stringArray.length>0) {
                                String screenName=stringArray[0];
                                String screenNumber= getScreenNumberForBusinessAssets(screenName);
                                if ( ! TextUtils.isEmpty(screenName) && ! TextUtils.isEmpty(screenNumber)) {
                                    removeAllChildFragments(ll.getId() + "");
                                    initChild(LOAN_TYPE, CLIENT_ID, PROJECT_ID_LOS, PRODUCT_ID_MSME, screenNumber,
                                            screenName, dynamicUITableList, dynamicUITable, dynamicUITable.getCoRelationID());
                        ...
                        }else if(dynamicUITable.getScreenName().equalsIgnoreCase(SCREEN_NAME_MORTGAGE_MSME)
                                && dynamicUITable.getLoanType().equalsIgnoreCase(LOAN_NAME_MSME)){
                            // TODO: MORTGAGE - ASSET TYPE
                            String[] stringArray=dynamicUITable.getFieldTag().split("_");
                            if( stringArray.length>0) {
                                String screenName=stringArray[0];
                                String screenNumber= getScreenNumberForMortgageFixedAssets(screenName);
                                if ( ! TextUtils.isEmpty(screenName) && ! TextUtils.isEmpty(screenNumber)) {
                                    removeAllChildFragments(ll.getId() + "");
                                    initChild(LOAN_TYPE, CLIENT_ID, PROJECT_ID_LOS, PRODUCT_ID_MSME, screenNumber,
                                            screenName, dynamicUITableList, dynamicUITable, dynamicUITable.getCoRelationID());
...
//            viewParameters.setValue(viewParameters.getDefaultValue());
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                removeAllChildFragments(ll.getId()+"");
                initChild(LOAN_TYPE,CLIENT_ID,PROJECT_ID_LOS,PRODUCT_ID_IL,SCREEN_N0_EMPLOYER_VERIFICATION,
