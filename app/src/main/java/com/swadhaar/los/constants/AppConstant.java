package com.swadhaar.los.constants;
...
import com.swadhaar.los.models.ScreenDetailsDTO;

import java.security.SecureRandom;
import java.util.HashMap;
import java.util.List;

import static com.swadhaar.los.dynamicui.constants.ParametersConstant.PROOF_TYPE_SPINNER_ITEM_ADDRESS_PROOF;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.PROOF_TYPE_SPINNER_ITEM_ID_CUM_ADDRESS_PROOF;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.PROOF_TYPE_SPINNER_ITEM_ID_CUM_SIGNATURE_PROOF;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.PROOF_TYPE_SPINNER_ITEM_SIGNATURE_PROOF;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_AADHAAR;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_AUTHORIZED_SIGNATURE_PROOF;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_BANK_PASSBOOK_WITH_PHOTOGRAPH;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_BANK_STATEMENT;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_BUILDING;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_CAR;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_COMMERCIAL_VEHICLE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_DEEMED_OVD;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_DRIVING_LICENSE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_EQUIPMENT;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_FURNITURE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_LAND;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_LIVESTOCK;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_NREGA_JOB_CARD;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_OPEN_PLOT;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_OTHERS;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_PAN_CARD;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_PASSPORT;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_PLANT_AND_MACHINERY;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_RATION_CARD;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_TV;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_TWO_WHEELER;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_UIDAI_ELIGIBLE_DOCUMENTS;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_UTILITIES;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_UTILITY_BILLS;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_VEHICLE;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_VID;
import static com.swadhaar.los.dynamicui.constants.ParametersConstant.SPINNER_ITEM_FIELD_NAME_VOTER_ID;

public class AppConstant {

    //     TODO: DEV
//    public static String env = "PP"; // TODO: UAT ENVIRONMENT
//    public static String APP_ENVIRONMENT="DEV"; // TODO: DEV APP ENVIRONMENT
//    public static String RESET_PASSWORD_TOKEN="Bearer "; // TODO: HARDCODED TOKEN FOR RESET PASSWORD
//    public static String LOGIN_URL = "https://rfs1.rblfinserve.com/balApi/"; // TODO: LOGIN URL
//    public static String LOGOUT_URL = "https://rfs-azu-w050.rblfinserve.com/balApi/"; // TODO: LOGOUT URL
//    public static String BEARER_TOKEN_URL = "https://rfs-azu-w001.centralindia.cloudapp.azure.com/identity/api/v1/uat/"; // TODO: BEARER TOKEN URL
//    public static String STAGE_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Transition/api/"; // TODO: STAGE URL
//    public static String WORKFLOW_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Transition/api/"; // TODO: WORKFLOW URL
//    public static String BASE_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/fileupload/api/"; // TODO: META DATA URL
//    public static String SUBMIT_DATA_POST_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Transition/api/"; // TODO: SYNC & WORKFLOW
//    public static String SUBMIT_DATA_POST_URL_LEAD = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/LossrvDatastore/api/"; // TODO: ONLY SYNC
//    public static String SUBMIT_DATA_POST_URL_JLG = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/JLGoperations/api/"; // TODO: JLG DATA SYNC
//    public static String RAW_DATA_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/dbutil/api/v1/uat/"; // TODO: RAW DATA URL
//    public static String PIN_CODE_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Pincode/api/WorkflowUser/v1/"; // TODO: PIN CODE URL
//    public static String EKYC_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/ekyc/api/v1/uat/"; // TODO: EKYC URL
//    public static String OTP_TRIGGER_URL ="http://rfs-azu-w001.centralindia.cloudapp.azure.com/otp/api/v1/uat/"; // TODO: OTP TRIGGER
//    public static String OTP_VERIFY_URL ="http://rfs-azu-w001.centralindia.cloudapp.azure.com/otp/api/v1/uat/"; // TODO: OTP VERIFY
////    public static String DOCUMENT_UPLOAD_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Docupload/api/uat/V1/uploadImages"; // TODO: DOCUMENT UPLOAD URL
//    public static String DOCUMENT_UPLOAD_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Docupload/api/uat/V1/uploadImages1"; // TODO: DOCUMENT UPLOAD URL
//    public static String DOCUMENT_DOWNLOAD_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Docupload/api/uat/"; // TODO: DOCUMEN                                                                                                                                                                                                               T DOWNLOAD URL
//    public static String LOG_TO_SERVER_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/logsService/api/v1/uat/"; // TODO: LOG TO SERVER URL
//    public static String PAN_VALIDATION_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: PAN VALIDATION URL
//    public static String AADHAAR_VAULT_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: AADHAAR VAULT URL
//    public static String CHANGE_PASSWORD_URL = "https://rfs-azu-w050.rblfinserve.com/balApi/"; // TODO: CHANGE PASSWORD
//    public static String RESET_PASSWORD_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/managecredentials/api/v1/uat/"; // TODO: RESET PASSWORD
//    public static String CIBIL_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: CIBIL
//    public static String GET_ROLE_NAMES_URL = "https://rfs-azu-w050.rblfinserve.com/balApi/"; // TODO: GET ROLE NAMES
//    public static String CB_MFI_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: CB MFI
//    public static String SALES_TOOL_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/SalesTool/api/v1/uat/"; // TODO: SALES TOOL
//    public static String INITIATE_TRANSACTION_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/collections/api/v1/uat/"; // TODO: SALES TOOL
...
//    public static String LOGIN_URL = "http://rfs-azu-w050.centralindia.cloudapp.azure.com:2047/balApi/"; // TODO: LOGIN URL
//    public static String LOGOUT_URL = "http://rfs-azu-w050.centralindia.cloudapp.azure.com:2047/balApi/"; // TODO: LOGOUT URL
//    public static String BEARER_TOKEN_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/identity/api/v1/uat/"; // TODO: BEARER TOKEN URL
//    public static String STAGE_URL = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/TranUAT/api/"; // TODO: STAGE URL
//    public static String WORKFLOW_URL = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/TranUAT/api/"; // TODO: WORKFLOW URL
//    public static String BASE_URL = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/fileupload/api/"; // TODO: META DATA URL
//    public static String SUBMIT_DATA_POST_URL_JLG = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/JLGoperations/api/"; // TODO: JLG DATA SYNC
//    public static String SUBMIT_DATA_POST_URL = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/TranUAT/api/"; // TODO: SYNC & WORKFLOW
//    public static String SUBMIT_DATA_POST_URL_LEAD = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/LossrvDatastore/api/"; // TODO: ONLY SYNC
//    public static String RAW_DATA_URL = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/dbutil/api/v1/uat/"; // TODO: RAW DATA URL
//    public static String PIN_CODE_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Pincode/api/WorkflowUser/v1/"; // TODO: PIN CODE URL
//    public static String EKYC_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/ekyc/api/v1/uat/"; // TODO: EKYC URL
//    public static String OTP_TRIGGER_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/otp/api/v1/uat/"; // TODO: OTP TRIGGER
//    public static String OTP_VERIFY_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/otp/api/v1/uat/"; // TODO: OTP VERIFY
//    public static String DOCUMENT_UPLOAD_URL = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/Docupload/api/uat/V1/uploadImages"; // TODO: DOCUMENT UPLOAD URL
//    public static String DOCUMENT_DOWNLOAD_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Docupload/api/uat/"; // TODO: DOCUMENT DOWNLOAD URL
//    public static String LOG_TO_SERVER_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/logsService/api/v1/uat/";  // TODO: LOG TO SERVER URL
//    public static String PAN_VALIDATION_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: PAN VALIDATION URL
//    public static String AADHAAR_VAULT_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: AADHAAR VAULT URL
//    public static StrFing CHANGE_PASSWORD_URL = "http://rfs-azu-w050.centralindia.cloudapp.azure.com:2047/balApi/"; // TODO: CHANGE PASSWORD
//    public static String RESET_PASSWORD_URL = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/managecredentials/api/v1/uat/"; // TODO: RESET PASSWORD
//    public static String CIBIL_URL = "http://rfs-azu-a017.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: CIBIL
//    public static String GET_ROLE_NAMES_URL = "http://rfs-azu-w050.centralindia.cloudapp.azure.com:2047/balApi/"; // TODO: GET ROLE NAMES
//    public static String CB_MFI_URL = " http://rfs-azu-a017.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: CB MFI
//    public static String SALES_TOOL_URL = " http://rfs-azu-a017.centralindia.cloudapp.azure.com/SalesTool/api/v1/uat/"; // TODO: SALES TOOL
//    public static String INITIATE_TRANSACTION_URL = " http://rfs-azu-w001.centralindia.cloudapp.azure.com/collections/api/v1/uat/"; // TODO: SALES TOOL
...
//    public static String INITIATE_TRANSACTION_URL = " https://losservicesuat.rblbank.com/collections/api/v1/prod/"; // TODO: TWINLINE FOR DIGITAL PAYMENT
    ...
    // TODO: LATEST UAT URLS FOR TESTING 2 no check this urls
    public static String env = "PP"; // TODO: UAT ENVIRONMENT
    public static String APP_ENVIRONMENT="UAT"; // TODO: UAT APP ENVIRONMENT
    public static String RESET_PASSWORD_TOKEN="Bearer "; // TODO: HARDCODED TOKEN FOR RESET PASSWORD
    public static String LOGIN_URL = "https://saarthakuat.rblfinserve.com/balApi/"; // TODO: LOGIN URL
    public static String LDAP_LOGIN_URL = "https://saartakuat.rblbank.com/rvfapi/api/v1/uat/RVF/"; // TODO: LOGIN URL
    public static String LOGOUT_URL = "https://saarthakuat.rblfinserve.com/balApi/"; // TODO: LOGOUT URL
    public static String BEARER_TOKEN_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/identity/api/v1/uat/"; // TODO: BEARER TOKEN URL
    public static String STAGE_URL = "http://losservicesuat.rblfinserve.com/TranUAT/api/"; // TODO: STAGE URL
    public static String WORKFLOW_URL = "http://losservicesuat.rblfinserve.com/TranUAT/api/"; // TODO: WORKFLOW URL
    public static String BASE_URL = "http://losservicesuat.rblfinserve.com/fileupload/api/"; // TODO: META DATA URL
    public static String SUBMIT_DATA_POST_URL_JLG = "http://losservicesuat.rblfinserve.com/JLGoperations/api/"; // TODO: JLG DATA SYNC
    public static String SUBMIT_DATA_POST_URL = "http://losservicesuat.rblfinserve.com/TranUAT/api/"; // TODO: SYNC & WORKFLOW
    public static String SUBMIT_DATA_POST_URL_LEAD = "http://losservicesuat.rblfinserve.com/LossrvDatastore/api/"; // TODO: ONLY SYNC
    public static String RAW_DATA_URL = "http://losservicesuat.rblfinserve.com/dbutil/api/v1/uat/"; // TODO: RAW DATA URL
    public static String PIN_CODE_URL = "http://www.postalpincode.in/api/"; // TODO: PIN CODE URL
    public static String EKYC_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/ekyc/api/v1/uat/"; // TODO: EKYC URL
    public static String OTP_TRIGGER_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/otp/api/v1/uat/"; // TODO: OTP TRIGGER
    public static String OTP_VERIFY_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/otp/api/v1/uat/"; // TODO: OTP VERIFY
//    public static String DOCUMENT_UPLOAD_URL = "http://losservicesuat.rblfinserve.com/Docupload/api/uat/V1/uploadImages"; // TODO: DOCUMENT UPLOAD URL
    public static String DOCUMENT_UPLOAD_URL = "http://losservicesuat.rblfinserve.com/Docupload/api/uat/V1/uploadImages1"; // TODO: DOCUMENT UPLOAD URL
    public static String DOCUMENT_DOWNLOAD_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/Docupload/api/uat/"; // TODO: DOCUMENT DOWNLOAD URL
    public static String LOG_TO_SERVER_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/logsService/api/v1/uat/";  // TODO: LOG TO SERVER URL
    public static String PAN_VALIDATION_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: PAN VALIDATION URL
    public static String AADHAAR_VAULT_URL = "http://rfs-azu-w001.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: AADHAAR VAULT URL
    public static String CHANGE_PASSWORD_URL = "https://saarthakuat.rblfinserve.com/balApi/"; // TODO: CHANGE PASSWORD
    public static String RESET_PASSWORD_URL = "http://losservicesuat.rblfinserve.com/managecredentials/api/v1/uat/"; // TODO: RESET PASSWORD
    public static String CIBIL_URL = "http://losservicesuat.rblfinserve.com/bankproxy/api/v1/uat/"; // TODO: CIBIL
    public static String GET_ROLE_NAMES_URL = "https://saarthakuat.rblfinserve.com/balApi/"; // TODO: GET ROLE NAMES
    public static String CB_MFI_URL = " http://losservicesuat.rblfinserve.com/bankproxy/api/v1/uat/"; // TODO: CB MFI
    public static String SALES_TOOL_URL = " http://losservicesuat.rblfinserve.com/SalesTool/api/v1/uat/"; // TODO: SALES TOOL
    public static String INITIATE_TRANSACTION_URL = " http://rfs-azu-w001.centralindia.cloudapp.azure.com/collections/api/v1/uat/"; // TODO: SALES TOOL
...
//    public static String RESET_PASSWORD_TOKEN="Bearer "; // TODO: HARDCODED TOKEN FOR RESET PASSWORD
//    public static String LOGIN_URL = " https://104.211.103.21/RFSONEBAL/balApi/"; // TODO: LOGIN URL
//    public static String LOGOUT_URL = " https://104.211.103.21/RFSONEBAL/balApi/"; // TODO: LOGOUT URL
//    public static String BEARER_TOKEN_URL = "https://losservices.rblfinserve.com/identityservice/api/v1/prod/"; // TODO: BEARER TOKEN URL
//    public static String STAGE_URL = "https://losservices.rblfinserve.com/LosTransProd/api/"; // TODO: STAGE URL
//    public static String WORKFLOW_URL = "https://losservices.rblfinserve.com/LosTransProd/api/"; // TODO: WORKFLOW URL
//    public static String BASE_URL = "https://LosServices.rblfinserve.com/LosMetaService/api/"; // TODO: META DATA URL
//    public static String SUBMIT_DATA_POST_URL = "https://losservices.rblfinserve.com/LosTransProd/api/"; // TODO: SYNC & WORKFLOW
//    public static String SUBMIT_DATA_POST_URL_LEAD = "https://losservices.rblfinserve.com/LossrvDatastoreProd/api/"; // TODO: ONLY SYNC
//    public static String SUBMIT_DATA_POST_URL_JLG = "https://losservices.rblfinserve.com/JLGoperations/api/"; // TODO: JLG DATA SYNC [ dummy url , not received tvName service team ]
//    public static String RAW_DATA_URL = "https://LosServices.rblfinserve.com/LosDBUtil/api/v1/prod/"; // TODO: RAW DATA URL
//    public static String PIN_CODE_URL = "https://losservices.rblfinserve.com/Pincode/api/WorkflowUser/v1/"; // TODO: PIN CODE URL
//    public static String EKYC_URL = "https://besure.rblfinserve.com/ekyc/api/v1/prod/"; // TODO: EKYC URL
//    public static String OTP_TRIGGER_URL = "https://besure.rblfinserve.com/otp/api/v1/prod/"; // TODO: OTP TRIGGER
//    public static String OTP_VERIFY_URL = "https://besure.rblfinserve.com/otp/api/v1/prod/"; // TODO: OTP VERIFY
//    public static String DOCUMENT_UPLOAD_URL = "https://LosServices.rblfinserve.com/LosDocuploadIL/api/uat/V1/uploadImages"; // TODO: DOCUMENT UPLOAD URL
//    public static String DOCUMENT_DOWNLOAD_URL = "https://LosServices.rblfinserve.com/LosDocuploadIL/api/uat/"; // TODO: DOCUMENT DOWNLOAD URL
//    public static String LOG_TO_SERVER_URL = "https://losservices.rblfinserve.com/LogsService/api/v1/prod/"; // TODO: LOG TO SERVER URL
//    public static String PAN_VALIDATION_URL = "https://besure.rblfinserve.com/ServiceGateway/api/v1/prod/"; // TODO: PAN VALIDATION URL
//    public static String AADHAAR_VAULT_URL = "https://besure.rblfinserve.com/ServiceGateway/api/v1/prod/"; // TODO: AADHAAR VAULT URL
//    public static String CHANGE_PASSWORD_URL = "https://104.211.103.21/RFSONEBAL/balApi/"; // TODO: CHANGE PASSWORD
//    public static String RESET_PASSWORD_URL = "https://losservices.rblfinserve.com/managecredentials/api/v1/prod/"; // TODO: RESET PASSWORD
//    public static String CIBIL_URL = "https://losservices.rblfinserve.com/LosServiceGateway/api/v1/prod/"; // TODO: CIBIL
//    public static String GET_ROLE_NAMES_URL = "https://104.211.103.21/RFSONEBAL/balApi/"; // TODO: GET ROLE NAMES
//    public static String CB_MFI_URL = " http://rfs-azu-a017.centralindia.cloudapp.azure.com/bankproxy/api/v1/uat/"; // TODO: CB MFI
//    public static String SALES_TOOL_URL = " http://rfs-azu-a017.centralindia.cloudapp.azure.com/SalesTool/api/v1/uat/"; // TODO: SALES TOOL
//    public static String INITIATE_TRANSACTION_URL = " http://rfs-azu-w001.centralindia.cloudapp.azure.com/collections/api/v1/uat/"; // TODO: TRANSACTION URL
...
//      public static String PIN_CODE_URL = "http://www.postalpincode.in/api/"; // TODO: PIN CODE URL
//      public static String EKYC_URL = "https://besure.rblbank.com/ekyc/api/v1/prod/"; // TODO: EKYC URL
...
//      public static String INITIATE_TRANSACTION_URL = " https://losservices.rblbank.com/collections/api/v1/prod/"; // TODO: TWINLINE FOR DIGITAL PAYMENT
    ...
    public static final String APP_FOLDER="LOS";
    public static final String DB_FOLDER="LOS_DB";
    ...
    // TODO: PROJECT NAME
    public static final String PROJECT_NAME_LOS ="LOS";

    // TODO: PROJECT ID
    public static final String PROJECT_ID_LOS ="1";
    ...
    public static final String WORKFLOW_ID_PHL="16";//WORKFLOW_ID_PHL="16";
    ...
    public static final String SCREEN_NAME_OFFICE_ADDRESS_PROOF = "OFFICE ADDRESS PROOF"; // TODO: AHL
    ...
    // TODO: MORTGAGE SCREEN NUMBERS MSME
    public static final String SCREEN_NO_MORTGAGE_MSME = "172";
    public static final String SCREEN_NO_MORTGAGE_BUILDING_MSME = "173";
    public static final String SCREEN_NO_MORTGAGE_LAND_MSME = "174";
    public static final String SCREEN_NO_MORTGAGE_OPEN_PLOT_MSME = "175";
   ...
   /* public static final String SCREEN_N0_HOUSE_ASSETS="26";
    ...
    /*//TODO: PHL SCREEN NUMBERS
    public static final String SCREEN_NO_COLD_CALLING_PHL = "1146";
    public static final String SCREEN_NO_COLLECTION_PHL = "1147";
    public static final String SCREEN_NO_APPLICANT_KYC_PHL = "1128";
    public static final String SCREEN_NO_CO_APPLICANT_KYC_PHL = "1129";
    public static final String SCREEN_NO_APPLICANT_LOAN_PROPOSAL_PHL = "1183";
    public static final String SCREEN_NO_NOMINEE_DETAIL_PHL = "1140";
    public static final String SCREEN_NO_BUSINESS_PROFILE_PHL = "1137";
    public static final String SCREEN_NO_BUSINESS_PROOF_PHL = "1207";
    public static final String SCREEN_NO_BUSINESS_ADDRESS_PROOF_PHL = "1253";
    public static final String SCREEN_NO_SALARY_PROFILE_PHL = "1335";
    public static final String SCREEN_NO_OFFICE_ADDRESS_PROOF_PHL = "1336";
    public static final String SCREEN_NO_BANK_DETAILS_PHL = "1139";
    public static final String SCREEN_NO_CO_APPLICANT_BANK_DETAILS_PHL = "1206";
    public static final String SCREEN_NO_ADDRESS_DETAIL_PHL = "1131";
    public static final String SCREEN_NO_PERSONAL_DETAIL_PHL = "1133";
    public static final String SCREEN_NO_SOCIO_ECONOMIC_DETAIL_PHL = "1134";
    public static final String SCREEN_NO_REFERENCE_CHECK_PHL = "1142";//SCREEN_NO_REFERENCES_PHL
    public static final String SCREEN_NO_COAPPLICANT_ADDRESS_DETAIL_PHL = "1136";
    public static final String SCREEN_NO_COAPPLICANT_PERSONAL_DETAIL_PHL = "1135";
    public static final String SCREEN_NO_COAPPLICANT_SOCIO_EOCONOMIC_DETAIL_PHL = "1205";
    ...
    // TODO: MORTGAGE SCREEN NUMBERS PHL
    public static final String SCREEN_NO_MORTGAGE_PHL = "1246";
    public static final String SCREEN_NO_MORTGAGE_BUILDING_PHL = "703";
    public static final String SCREEN_NO_MORTGAGE_LAND_PHL = "704";
    public static final String SCREEN_NO_MORTGAGE_OPEN_PLOT_PHL = "705";*/
    ...
    public static final String SCREEN_NO_APPLICANT_KYC_PHL = "532";
    public static final String SCREEN_NO_CO_APPLICANT_KYC_PHL = "533";
    public static final String SCREEN_NO_APPLICANT_LOAN_PROPOSAL_PHL = "620";
    public static final String SCREEN_NO_NOMINEE_DETAIL_PHL = "544";
    public static final String SCREEN_NO_BUSINESS_PROFILE_PHL = "541";
    public static final String SCREEN_NO_BUSINESS_PROOF_PHL = "663";
    public static final String SCREEN_NO_BUSINESS_ADDRESS_PROOF_PHL = "721";
    ...
    public static final String SCREEN_NO_BANK_DETAILS_PHL = "543";
    public static final String SCREEN_NO_CO_APPLICANT_BANK_DETAILS_PHL = "662";
    public static final String SCREEN_NO_ADDRESS_DETAIL_PHL = "535";
    public static final String SCREEN_NO_PERSONAL_DETAIL_PHL = "537";
    public static final String SCREEN_NO_SOCIO_ECONOMIC_DETAIL_PHL = "538";
    public static final String SCREEN_NO_REFERENCE_CHECK_PHL = "546";
    ...
    public static final String SCREEN_N0_HOUSE_INCOME_SUMMARY_PHL = "722";
    public static final String SCREEN_N0_GENERAL_INCOME_PHL = "723";
    public static final String SCREEN_N0_OTHER_INCOME_SOURCE_PHL = "724";
    public static final String SCREEN_N0_HOUSE_EXPENSES_PHL = "725";

    // TODO: AHL BUSINESS INCOME
    public static final String SCREEN_N0_DECALRED_SALES_WEEKLY_PHL = "680";
    public static final String SCREEN_N0_DECALRED_SALES_YEARLY_PHL = "681";
    public static final String SCREEN_N0_BANKING_HISTORY_PHL = "682";
    public static final String SCREEN_N0_MONTHLY_TRANSACTION_DETAIL_PHL = "683";
    public static final String SCREEN_N0_SALES_BILLS_PHL = "684";
    public static final String SCREEN_N0_SALES_BILLS_DETAIL_PHL = "685";
    public static final String SCREEN_N0_PURCHASE_BILLS_PHL = "686";
    public static final String SCREEN_N0_PURCHASE_BILLS_DETAIL_PHL = "687";
    public static final String SCREEN_N0_GST_PHL = "688";
    public static final String SCREEN_N0_ITR_PHL = "689";
    public static final String SCREEN_N0_ITR_DETAIL_PHL = "160";
    public static final String SCREEN_N0_PRODUCT_ESTIMATE_PHL = "161";
    public static final String SCREEN_N0_PRODUCT_ESTIMATE_DETAIL_PHL = "162";
    public static final String SCREEN_N0_PRODUCT_RAW_MATERIAL_PHL = "163";
    ...
    public static final String SCREEN_N0_DOCUMENT_UPLOAD_PHL = "739";
    ...
    public static final String SCREEN_N0_DECISIONS_LOAN_INFORMATION_PHL = "707";
    public static final String SCREEN_N0_DECISIONS_SUBJECT_TO_CONDITIONS_PHL = "708";
    public static final String SCREEN_N0_CASH_FLOW_SUMMARY_PHL = "213";
    public static final String SCREEN_N0_LOAN_APPROVAL_PHL = "216";
    public static final String SCREEN_N0_LOAN_SUGGESTION_PHL = "218";
    ...
    public static final String SCREEN_NO_MORTGAGE_PHL = "702";
    public static final String SCREEN_NO_MORTGAGE_BUILDING_PHL = "703";
    public static final String SCREEN_NO_MORTGAGE_LAND_PHL = "704";
    public static final String SCREEN_NO_MORTGAGE_OPEN_PLOT_PHL = "705";
    ...
    public static final String SCREEN_NO_SALARY_PROFILE_AHL = "1061";
    public static final String SCREEN_NO_OFFICE_ADDRESS_PROOF_AHL = "1062";
    ...
    public static final String SCREEN_N0_LEAD_PHL = "530"; // TODO: PHL lead screen no 1127
    ...
    // TODO: APPLICANT MODULE NAME LIST AHL with condition
    public static String[] APPLICANT_MODULE_NAME_LIST_AHL = {
            MODULE_TYPE_APPLICANT,
            MODULE_TYPE_CO_APPLICANT + 1, // TODO: for co applicant validation
            MODULE_TYPE_SALARY,
            MODULE_TYPE_LOAN_PROPOSAL_WITH_NOMINEE
    };
    public static String[] APPLICANT_MODULE_NAME_LIST_PHL = {
            MODULE_TYPE_APPLICANT,
            MODULE_TYPE_CO_APPLICANT + 1, // TODO: for co applicant validation
            MODULE_TYPE_SALARY,
            MODULE_TYPE_LOAN_PROPOSAL_WITH_NOMINEE
    };
    // TODO: APPLICANT MODULE NAME LIST - JLG
    public static String[] APPLICANT_MODULE_NAME_LIST_JLG = {
            MODULE_TYPE_APPLICANT
    };
    public static String[] LOAN_APPLICATION_MODULE_NAME_LIST_JLG = {
            MODULE_TYPE_APPLICANT,
            MODULE_TYPE_LOAN_PROPOSAL_WITH_NOMINEE
    };

    // TODO: PD MODULE NAME LIST IL
    public static String[] PD_MODULE_NAME_LIST_IL = {
            MODULE_TYPE_HOUSE_LIABILITY,
//            MODULE_TYPE_HOUSE_ASSETS,
            MODULE_TYPE_BUSINESS_ASSETS,
            MODULE_TYPE_BUSINESS_LIABILITY,
            MODULE_TYPE_HOUSE_INCOME,
            MODULE_TYPE_HOUSE_EXPENSE,
            MODULE_TYPE_MANUFACTURE_BUSINESS_INCOME,
            MODULE_TYPE_LOAN_PROPOSAL_PD,
            MODULE_TYPE_DECISIONS
    };

    // TODO: PD MODULE NAME LIST MSME
    public static String[] PD_MODULE_NAME_LIST_MSME = {
            MODULE_TYPE_HOUSE_LIABILITY,
            MODULE_TYPE_HOUSE_ASSETS,
            MODULE_TYPE_BUSINESS_ASSETS,
            MODULE_TYPE_BUSINESS_LIABILITY,
    ...
    // TODO: PD MODULE NAME LIST MSME WITH service and without manifacture
    public static String[] PD_MODULE_NAME_LIST_MSME_WITH_SERVICE = {
            MODULE_TYPE_HOUSE_LIABILITY,
            MODULE_TYPE_HOUSE_ASSETS,
            MODULE_TYPE_BUSINESS_ASSETS,
            MODULE_TYPE_BUSINESS_LIABILITY,
            MODULE_TYPE_HOUSE_INCOME,
            MODULE_TYPE_HOUSE_EXPENSE,
            MODULE_TYPE_SERVICE_BUSINESS_INCOME,
            MODULE_TYPE_DECISIONS
    };
    ...
    public static final String LOAN_NAME_PHL = "PHL";

    public static String[] TAB_SCREEN_NAMES = {
            SCREEN_NAME_APPLICANT_KYC,
            SCREEN_NAME_CO_APPLICANT_KYC,
            SCREEN_NAME_ADDRESS_DETAIL,
            SCREEN_NAME_APPLICANT_SIGNATURE,
    ...
    // TODO: INDIVIDUAL
    public static String[] INDIVIDUAL_TAB_SCREEN_NAMES = {
            SCREEN_NAME_APPLICANT_KYC,
            SCREEN_NAME_CO_APPLICANT_KYC,
    ...
    // TODO: INDIVIDUAL MANDATORY SCREENS TO CHECK
    public static String[] INDIVIDUAL_TAB_SCREEN_NUMBERS = {
            SCREEN_NO_APPLICANT_KYC_IL,
            SCREEN_NO_CO_APPLICANT_KYC_IL,
            SCREEN_NO_LOAN_PROPOSAL_IL,
            SCREEN_NO_NOMINEE_DETAIL_IL,
            SCREEN_NO_ADDRESS_DETAIL_IL,
            SCREEN_NO_PERSONAL_DETAIL_IL,
            SCREEN_NO_SOCIO_ECONOMIC_DETAIL_IL,
            ...
            SCREEN_NO_BUSINESS_PROFILE_IL,
            SCREEN_NO_BUSINESS_PROOF_IL,
            SCREEN_NO_BUSINESS_ADDRESS_PROOF_IL,
//            SCREEN_NO_BANK_DETAILS_IL,
            SCREEN_NO_REFERENCE_CHECK_IL/*,
            SCREEN_NO_DOCUMENT_UPLOAD*/
    };


    // TODO: MSME
    public static String[] MSME_TAB_SCREEN_NUMBERS = {
            SCREEN_NO_APPLICANT_KYC_MSME,
            SCREEN_NO_CO_APPLICANT_KYC_MSME,
            SCREEN_NO_APPLICANT_LOAN_PROPOSAL_MSME,
            SCREEN_NO_NOMINEE_DETAIL_MSME,
            SCREEN_NO_ADDRESS_DETAIL_MSME,
            SCREEN_NO_PERSONAL_DETAIL_MSME,
            SCREEN_NO_SOCIO_ECONOMIC_DETAIL_MSME,
            SCREEN_NO_COAPPLICANT_ADDRESS_DETAIL_MSME,
            SCREEN_NO_COAPPLICANT_PERSONAL_DETAIL_MSME,
            SCREEN_NO_COAPPLICANT_SOCIO_EOCONOMIC_DETAIL_MSME,
            SCREEN_NO_BUSINESS_PROFILE_MSME,
            SCREEN_NO_BUSINESS_PROOF_MSME,
            SCREEN_NO_BUSINESS_ADDRESS_PROOF_MSME,
            SCREEN_NO_BANK_DETAILS_MSME,
            SCREEN_NO_REFERENCE_CHECK_MSME/*,
            SCREEN_NO_DOCUMENT_UPLOAD*/
    };
    public static int[] INDIVIDUAL_TAB_ICONS = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_group_black_24dp,
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_person_pin_black_24dp,
...
//            SCREEN_NAME_BANK_DETAILS
    ...
    public static String[] APPLICANT_TAB_SCREEN_NUMBERS_JLG = {
            SCREEN_NO_APPLICANT_KYC_JLG,
            SCREEN_NO_PERSONAL_DETAIL_JLG,
//            SCREEN_NO_ADDRESS_DETAIL_JLG,
            SCREEN_NO_SOCIO_ECONOMIC_DETAIL_JLG
//            SCREEN_NO_BANK_DETAILS_JLG
    };

    public static int[] APPLICANT_TAB_ICONS_NAMES_JLG = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_person_white_24dp,
//            R.drawable.ic_home_black_24dp,
            R.drawable.ic_domain_black_24dp
//            R.drawable.ic_location_city_black_24dp
    ...
    // TODO: VILLAGE SURVEY JLG
    public static String[] VILLAGE_SURVEY_TAB_SCREEN_NAMES_JLG = {
            SCREEN_NAME_VILLAGE_SURVEY,
    };

    public static String[] VILLAGE_SURVEY_TAB_SCREEN_NUMBERS_JLG = {
            SCREEN_NO_VILLAGE_SURVEY_JLG
    };

    public static int[] VILLAGE_SURVEY_TAB_ICONS_NAMES_JLG = {
            R.drawable.ic_location_city_black_24dp
    };

    // TODO: CENTER CREATION SURVEY JLG
    public static String[] CENTER_CREATION_TAB_SCREEN_NAMES_JLG = {
            SCREEN_NAME_CENTER_CREATION,
    };

    public static String[] CENTER_CREATION_TAB_SCREEN_NUMBERS_JLG = {
            SCREEN_NO_CENTER_CREATION_JLG
    };

    public static int[] CENTER_CREATION_TAB_ICONS_NAMES_JLG = {
            R.drawable.ic_location_city_black_24dp
    };
    ...
    public static int[] APPLICANT_TAB_ICONS_NAMES_IL = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_person_white_24dp,
            R.drawable.ic_domain_black_24dp,
    ...
    // TODO: APPLICANT MSME
    public static String[] APPLICANT_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_APPLICANT_KYC,
            SCREEN_NAME_ADDRESS_DETAIL,
            SCREEN_NAME_PERSONAL_DETAIL,
            SCREEN_NAME_SOCIO_ECONOMIC_DETAIL,
    ...
    public static String[] APPLICANT_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_APPLICANT_KYC_MSME,
            SCREEN_NO_ADDRESS_DETAIL_MSME,
            SCREEN_NO_PERSONAL_DETAIL_MSME,
            SCREEN_NO_SOCIO_ECONOMIC_DETAIL_MSME,
    ...
    public static int[] APPLICANT_TAB_ICONS_NAMES_MSME = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_person_white_24dp,
            R.drawable.ic_domain_black_24dp,
    ...
    // TODO: APPLICANT AHL
    public static String[] APPLICANT_TAB_SCREEN_NAMES_AHL = {
            SCREEN_NAME_APPLICANT_KYC,
            SCREEN_NAME_ADDRESS_DETAIL,
            SCREEN_NAME_PERSONAL_DETAIL,
            SCREEN_NAME_SOCIO_ECONOMIC_DETAIL,
    ...
    public static String[] APPLICANT_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_APPLICANT_KYC_AHL,
            SCREEN_NO_ADDRESS_DETAIL_AHL,
            SCREEN_NO_PERSONAL_DETAIL_AHL,
            SCREEN_NO_SOCIO_ECONOMIC_DETAIL_AHL,
            SCREEN_NO_BANK_DETAILS_AHL,
            SCREEN_NO_REFERENCE_CHECK_AHL
    };
    public static String[] APPLICANT_TAB_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_APPLICANT_KYC_PHL,
            SCREEN_NO_ADDRESS_DETAIL_PHL,
            SCREEN_NO_PERSONAL_DETAIL_PHL,
            SCREEN_NO_SOCIO_ECONOMIC_DETAIL_PHL,
            SCREEN_NO_BANK_DETAILS_PHL,
            SCREEN_NO_REFERENCE_CHECK_PHL
    };

    public static int[] APPLICANT_TAB_ICONS_NAMES_AHL = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_person_white_24dp,
            R.drawable.ic_domain_black_24dp,
    ...
    public static int[] CO_APPLICANT_TAB_ICONS_NAMES_IL = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_person_white_24dp,
            R.drawable.ic_domain_black_24dp,
    ...
    // TODO: CO APPLICANT MSME
    public static String[] CO_APPLICANT_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_CO_APPLICANT_KYC,
            SCREEN_NAME_COAPPLICANT_ADDRESS_DETAIL,
            SCREEN_NAME_COAPPLICANT_PERSONAL_DETAIL,
            SCREEN_NAME_COAPPLICANT_SOCIO_ECONOMIC_DETAIL,
    ...
    public static String[] CO_APPLICANT_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_CO_APPLICANT_KYC_MSME,
            SCREEN_NO_COAPPLICANT_ADDRESS_DETAIL_MSME,
            SCREEN_NO_COAPPLICANT_PERSONAL_DETAIL_MSME,
            SCREEN_NO_COAPPLICANT_SOCIO_EOCONOMIC_DETAIL_MSME,
            SCREEN_NO_CO_APPLICANT_BANK_DETAILS_MSME
    };

    public static int[] CO_APPLICANT_TAB_ICONS_NAMES_MSME = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_person_white_24dp,
            R.drawable.ic_domain_black_24dp,
    ...
    public static String[] CO_APPLICANT_TAB_SCREEN_NAMES_AHL = {
            SCREEN_NAME_CO_APPLICANT_KYC,
            SCREEN_NAME_COAPPLICANT_ADDRESS_DETAIL,
            SCREEN_NAME_COAPPLICANT_PERSONAL_DETAIL,
            SCREEN_NAME_COAPPLICANT_SOCIO_ECONOMIC_DETAIL,
    ...
    public static String[] CO_APPLICANT_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_CO_APPLICANT_KYC_AHL,
            SCREEN_NO_COAPPLICANT_ADDRESS_DETAIL_AHL,
            SCREEN_NO_COAPPLICANT_PERSONAL_DETAIL_AHL,
            SCREEN_NO_COAPPLICANT_SOCIO_EOCONOMIC_DETAIL_AHL,
            SCREEN_NO_CO_APPLICANT_BANK_DETAILS_AHL
    };
    public static String[] CO_APPLICANT_TAB_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_CO_APPLICANT_KYC_PHL,
    ...
    public static int[] CO_APPLICANT_TAB_ICONS_NAMES_AHL = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_person_white_24dp,
            R.drawable.ic_domain_black_24dp,
    ...
    // TODO: BUSINESS IL
    public static String[] BUSINESS_TAB_SCREEN_NAMES_IL = {
            SCREEN_NAME_BUSINESS_PROFILE,
            SCREEN_NAME_BUSINESS_PROOF,
            SCREEN_NAME_BUSINESS_ADDRESS_PROOF
    };

    public static String[] BUSINESS_TAB_SCREEN_NUMBERS_IL = {
            SCREEN_NO_BUSINESS_PROFILE_IL,
            SCREEN_NO_BUSINESS_PROOF_IL,
            SCREEN_NO_BUSINESS_ADDRESS_PROOF_IL,
    };

    public static int[] BUSINESS_TAB_ICONS_IL = {
            R.drawable.ic_business_center_black_24dp,
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_home_black_24dp
    };
    ...
    // TODO: BUSINESS MSME
    public static String[] BUSINESS_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_BUSINESS_PROFILE,
            SCREEN_NAME_BUSINESS_PROOF,
            SCREEN_NAME_BUSINESS_ADDRESS_PROOF
    };

    public static String[] BUSINESS_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_BUSINESS_PROFILE_MSME,
            SCREEN_NO_BUSINESS_PROOF_MSME,
            SCREEN_NO_BUSINESS_ADDRESS_PROOF_MSME
    };

    public static int[] BUSINESS_TAB_ICONS_MSME = {
            R.drawable.ic_business_center_black_24dp,
    ...
    // TODO: BUSINESS AHL
    public static String[] BUSINESS_TAB_SCREEN_NAMES_AHL = {
            SCREEN_NAME_BUSINESS_PROFILE,
            SCREEN_NAME_BUSINESS_PROOF,
            SCREEN_NAME_BUSINESS_ADDRESS_PROOF
    };

    public static String[] BUSINESS_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_BUSINESS_PROFILE_AHL,
            SCREEN_NO_BUSINESS_PROOF_AHL,
            SCREEN_NO_BUSINESS_ADDRESS_PROOF_AHL
    };
    public static String[] BUSINESS_TAB_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_BUSINESS_PROFILE_PHL,
            SCREEN_NO_BUSINESS_PROOF_PHL,
            SCREEN_NO_BUSINESS_ADDRESS_PROOF_PHL
    };

    public static int[] BUSINESS_TAB_ICONS_AHL = {
            R.drawable.ic_business_center_black_24dp,
            R.drawable.ic_business_proof_24,
            R.drawable.ic_business_add_proof2_24
    };
    ...
    // TODO: SALARY PHL
    public static String[] SALARY_TAB_SCREEN_NAMES_PHL = {
            SCREEN_NAME_SALARY_PROFILE,
            SCREEN_NAME_OFFICE_ADDRESS_PROOF
    };

    public static String[] SALARY_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_SALARY_PROFILE_AHL,
            SCREEN_NO_OFFICE_ADDRESS_PROOF_AHL
    };

    public static String[] SALARY_TAB_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_SALARY_PROFILE_PHL,
            SCREEN_NO_OFFICE_ADDRESS_PROOF_PHL
    };

    public static int[] SALARY_TAB_ICONS_AHL = {
            R.drawable.ic_business_center_black_24dp,
            R.drawable.ic_business_add_proof2_24
    };

    // TODO: BALANCE SHEET MODULE
    public static String[] BALANCE_SHEET_MODULE_SCREEN_NAMES = {
            SCREEN_NAME_HOUSE_ASSETS,
            SCREEN_NAME_HOUSE_LIABILITIES,
            SCREEN_NAME_BUSINESS_ASSETS,
            SCREEN_NAME_BUSINESS_LIABILITIES
    };

    public static int[] BALANCE_SHEET_MODULE_ICONS = {
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_location_city_black_24dp,
            R.drawable.ic_business_center_black_24dp,
    ...
    // TODO: INCOME ASSESSMENT MODULE
    public static String[] INCOME_ASSESSMENT_MODULE_SCREEN_NAMES = {
            SCREEN_NAME_HOUSE_INCOME,
            SCREEN_NAME_FAMILY_MEMBER_INCOME,
            SCREEN_NAME_EMPLOYER_VERIFICATION,
            SCREEN_NAME_HOUSE_EXPENSES
    };

    public static int[] INCOME_ASSESSMENT_MODULE_ICONS = {
            R.drawable.ic_home_black_24dp,
            R.drawable.ic_group_black_24dp,
    ...
    // TODO: HOUSE INCOME MODULE IL
    public static String[] HOUSE_INCOME_MODULE_SCREEN_NAMES_IL = {
            SCREEN_NAME_HOUSE_INCOME
    };

    public static String[] HOUSE_INCOME_MODULE_SCREEN_NUMBERS_IL = {
            SCREEN_N0_HOUSE_INCOME
    };

    public static int[] HOUSE_INCOME_MODULE_ICONS_IL = {
            R.drawable.ic_home_black_24dp
    };

    // TODO: HOUSE INCOME MODULE MSME
    public static String[] HOUSE_INCOME_MODULE_SCREEN_NAMES_MSME = {
            SCREEN_NAME_GENERAL_INCOME,
            SCREEN_NAME_OTHER_INCOME_SOURCE,
            SCREEN_NAME_HOUSE_INCOME_SUMMARY
    };

    public static String[] HOUSE_INCOME_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_GENERAL_INCOME_MSME,
            SCREEN_N0_OTHER_INCOME_SOURCE_MEME,
            SCREEN_N0_HOUSE_INCOME_SUMMARY_MSME
    };

    public static int[] HOUSE_INCOME_MODULE_ICONS_MSME = {
            R.drawable.ic_loan_proposal_24,
            R.drawable.ic_attach_money_black_24dp,
            R.drawable.ic_home_black_24dp
    };

    // TODO: HOUSE INCOME MODULE AHL
    public static String[] HOUSE_INCOME_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_GENERAL_INCOME,
            SCREEN_NAME_OTHER_INCOME_SOURCE,
            SCREEN_NAME_HOUSE_INCOME_SUMMARY
    };

    public static String[] HOUSE_INCOME_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_GENERAL_INCOME_AHL,
            SCREEN_N0_OTHER_INCOME_SOURCE_AHL,
            SCREEN_N0_HOUSE_INCOME_SUMMARY_AHL
    };
    public static String[] HOUSE_INCOME_MODULE_SCREEN_NUMBERS_PHL = {
            SCREEN_N0_GENERAL_INCOME_PHL,
            SCREEN_N0_OTHER_INCOME_SOURCE_PHL,
            SCREEN_N0_HOUSE_INCOME_SUMMARY_PHL
    };

    public static int[] HOUSE_INCOME_MODULE_ICONS_AHL = {
            R.drawable.ic_loan_proposal_24,
            R.drawable.ic_attach_money_black_24dp,
            R.drawable.ic_home_black_24dp
    };

    // TODO: HOUSE EXPENSE MODULE IL
    public static String[] HOUSE_EXPENSE_MODULE_SCREEN_NAMES_IL = {
            SCREEN_NAME_HOUSE_EXPENSES
    };

    public static String[] HOUSE_EXPENSE_MODULE_SCREEN_NUMBERS_IL = {
            SCREEN_N0_HOUSE_EXPENSES
    };

    public static int[] HOUSE_EXPENSE_MODULE_ICONS_IL = {
            R.drawable.ic_location_city_black_24dp
    };

    // TODO: HOUSE EXPENSE MODULE MSME
    public static String[] HOUSE_EXPENSE_MODULE_SCREEN_NAMES_MSME = {
            SCREEN_NAME_HOUSE_EXPENSES
    };

    public static String[] HOUSE_EXPENSE_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_HOUSE_EXPENSES_MSME
    };

    public static int[] HOUSE_EXPENSE_MODULE_ICONS_MSME = {
            R.drawable.ic_location_city_black_24dp
    };

    // TODO: HOUSE EXPENSE MODULE AHL
    public static String[] HOUSE_EXPENSE_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_HOUSE_EXPENSES
    };

    public static String[] HOUSE_EXPENSE_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_HOUSE_EXPENSES_AHL
    };
    public static String[] HOUSE_EXPENSE_MODULE_SCREEN_NUMBERS_PHL = {
            SCREEN_N0_HOUSE_EXPENSES_PHL
    };

    public static int[] HOUSE_EXPENSE_MODULE_ICONS_AHL = {
            R.drawable.ic_location_city_black_24dp
    };

    // TODO: REFERENCES MODULE
    public static String[] REFERENCES_MODULE_SCREEN_NAMES_IL = {
            SCREEN_NAME_REFERENCES
    };
    public static String[] REFERENCES_MODULE_SCREEN_NUMBERS_IL = {
            SCREEN_NO_REFERENCES_IL
    };
    public static int[] REFERENCES_MODULE_ICONS_IL = {
            R.drawable.ic_fingerprint_24dp
    };

    // TODO: REFERENCES MODULE
    public static String[] REFERENCES_MODULE_SCREEN_NAMES_MSME = {
            SCREEN_NAME_REFERENCES
    };
    public static String[] REFERENCES_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_REFERENCES_MSME
    };
    public static int[] REFERENCES_MODULE_ICONS_MSME = {
            R.drawable.ic_fingerprint_24dp
    };

    // TODO: REFERENCES MODULE
    public static String[] REFERENCES_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_REFERENCES
    };
    public static String[] REFERENCES_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_REFERENCES_AHL
    };
    public static String[] REFERENCES_MODULE_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_REFERENCES_PHL
    };
    public static int[] REFERENCES_MODULE_ICONS_AHL = {
            R.drawable.ic_fingerprint_24dp
    };
    ...
    public static int[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_ICONS_IL = {
            R.drawable.ic_collections_black_24dp,
            R.drawable.ic_collections_black_24dp
    };

    // TODO: LOAN PROPOSAL WITH NOMINEE MODULE JLG
    ...
    public static String[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NUMBERS_JLG = {
            SCREEN_NO_APPLICANT_LOAN_PROPOSAL_JLG,
            SCREEN_NO_NOMINEE_DETAILS_JLG,
            SCREEN_NO_ADDRESS_DETAIL_JLG,
            SCREEN_NO_BANK_DETAILS_JLG
    };
    public static int[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_ICONS_JLG = {
            R.drawable.ic_person_white_24dp,
    ...
    // TODO: LOAN PROPOSAL WITH NOMINEE MODULE MSME
    public static String[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NAMES_MSME = {
            SCREEN_NAME_APPLICANT_LOAN_PROPOSAL,
            SCREEN_NAME_NOMINEE_DETAIL
    };
    public static String[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_APPLICANT_LOAN_PROPOSAL_MSME,
            SCREEN_NO_NOMINEE_DETAIL_MSME
    };
    public static int[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_ICONS_MSME = {
            R.drawable.ic_collections_black_24dp,
            R.drawable.ic_nominee_24dp
    };

    // TODO: LOAN PROPOSAL WITH NOMINEE MODULE AHL
    public static String[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_APPLICANT_LOAN_PROPOSAL,
            SCREEN_NAME_NOMINEE_DETAIL
    };
    public static String[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_APPLICANT_LOAN_PROPOSAL_AHL,
            SCREEN_NO_NOMINEE_DETAIL_AHL
    };
    public static int[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_ICONS_AHL = {
            R.drawable.ic_collections_black_24dp,
            R.drawable.ic_nominee_24dp
    };

    public static String[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_APPLICANT_LOAN_PROPOSAL_PHL,
            SCREEN_NO_NOMINEE_DETAIL_PHL
    };
    public static int[] LOAN_PROPOSAL_WITH_NOMINEE_MODULE_ICONS_PHL = {
            R.drawable.ic_collections_black_24dp,
            R.drawable.ic_nominee_24dp
    };

    // TODO: LOAN APPLICATION MODULE JLG
    public static String[] LOAN_APPLICATION_MODULE_SCREEN_NAMES_JLG = {
            SCREEN_NAME_APPLICANT_KYC,
            SCREEN_NAME_PERSONAL_DETAIL,
            SCREEN_NAME_APPLICANT_LOAN_PROPOSAL,
            SCREEN_NAME_NOMINEE_DETAIL,
    ...
    public static String[] LOAN_APPLICATION_MODULE_SCREEN_NUMBERS_JLG = {
            SCREEN_NO_APPLICANT_KYC_JLG,
            SCREEN_NO_PERSONAL_DETAIL_JLG,
            SCREEN_NO_APPLICANT_LOAN_PROPOSAL_JLG,
            SCREEN_NO_NOMINEE_DETAILS_JLG,
    ...
    public static int[] LOAN_APPLICATION_MODULE_ICONS_JLG = {
            R.drawable.ic_fingerprint_24dp,
            R.drawable.ic_person_white_24dp,
            R.drawable.ic_person_white_24dp,
            R.drawable.ic_nominee_24dp,
    ...
    public static String[] LOAN_PROPOSAL_MODULE_SCREEN_NUMBERS_IL = {
            SCREEN_NO_LOAN_PROPOSAL_IL
    };
    public static int[] LOAN_PROPOSAL_MODULE_ICONS_IL = {
            R.drawable.ic_collections_black_24dp
    };

    // TODO: LOAN PROPOSAL MODULE MSME
    public static String[] LOAN_PROPOSAL_MODULE_SCREEN_NAMES_MSME = {
            SCREEN_NAME_LOAN_PROPOSAL
    };
    public static String[] LOAN_PROPOSAL_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_APPLICANT_LOAN_PROPOSAL_MSME
    };
    public static int[] LOAN_PROPOSAL_MODULE_ICONS_MSME = {
            R.drawable.ic_collections_black_24dp
    };
    ...
    public static String[] LOAN_PROPOSAL_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_APPLICANT_LOAN_PROPOSAL_AHL
    };
    ...
    // TODO: DOCUMENTS MODULE IL
    public static String[] DOCUMENTS_MODULE_SCREEN_NAMES_IL = {
            SCREEN_NAME_DOCUMENT_UPLOAD
    };
    public static String[] DOCUMENTS_MODULE_SCREEN_NUMBERS_IL = {
            SCREEN_NAME_DOCUMENT_UPLOAD
    };
    public static int[] DOCUMENTS_MODULE_ICONS_IL = {
            R.drawable.ic_collections_black_24dp
    };

    // TODO: DOCUMENTS MODULE MSME
    public static String[] DOCUMENTS_MODULE_SCREEN_NAMES_MSME = {
            SCREEN_NAME_DOCUMENT_UPLOAD
    };
    public static String[] DOCUMENTS_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_DOCUMENT_UPLOAD_MSME
    };
    public static int[] DOCUMENTS_MODULE_ICONS_MSME = {
            R.drawable.ic_collections_black_24dp
    };
    ...
    public static String[] DOCUMENTS_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_DOCUMENT_UPLOAD_AHL
    };
    ...
    // TODO: DOCUMENTS MODULE JLG
    public static String[] DOCUMENTS_MODULE_SCREEN_NAMES_JLG = {
            SCREEN_NAME_DOCUMENT_UPLOAD
    };
    public static String[] DOCUMENTS_MODULE_SCREEN_NUMBERS_JLG = {
            SCREEN_N0_DOCUMENT_UPLOAD_MSME
    };
    public static int[] DOCUMENTS_MODULE_ICONS_JLG = {
            R.drawable.ic_collections_black_24dp
    };
    ...
    // TODO: GENERATE CIBIL ( common for all loan )
    public static String[] GENERATE_CIBIL_MODULE_SCREEN_NAMES = {
            SCREEN_NAME_GENERATE_CIBIL
    };
    public static String[] GENERATE_CIBIL_MODULE_SCREEN_NUMBERS = {
            SCREEN_NO_GENERATE_CIBIL
    };
    public static int[] GENERATE_CIBIL_MODULE_ICONS = {
            R.drawable.otp_verification_icon
    };
    // TODO: GENERATE CIBIL AHL
    public static String[] GENERATE_CIBIL_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_GENERATE_CIBIL
    };
    public static String[] GENERATE_CIBIL_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_GENERATE_CIBIL_AHL
    };
    public static String[] GENERATE_CIBIL_MODULE_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_GENERATE_CIBIL_PHL
    };
    public static int[] GENERATE_CIBIL_MODULE_ICONS_AHL = {
            R.drawable.otp_verification_icon
    };

    // TODO: HOUSE LIABILITY IL
    public static String[] HOUSE_LIABILITY_MODULE_SCREEN_NAMES_IL = {
            SCREEN_NAME_HOUSE_LIABILITIES
    };
    public static String[] HOUSE_LIABILITY_MODULE_SCREEN_NUMBERS_IL = {
            SCREEN_N0_HOUSE_LIABILITIES
    };
    public static int[] HOUSE_LIABILITY_MODULE_ICONS_IL = {
            R.drawable.ic_home_black_24dp
    };
    ...
    public static String[] HOUSE_LIABILITY_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_HOUSE_LIABILITIES_MSME
    };
    public static int[] HOUSE_LIABILITY_MODULE_ICONS_MSME = {
            R.drawable.ic_home_black_24dp
    };

    // TODO: HOUSE ASSETS MSME
    public static String[] HOUSE_ASSETS_MODULE_SCREEN_NAMES_MSME = {
            SCREEN_NAME_HOUSE_ASSETS_MSME
    };
    ...
    public static int[] HOUSE_ASSETS_MODULE_ICONS_MSME = {
            R.drawable.ic_location_city_black_24dp
    };

    // TODO: HOUSE LIABILITY AHL
    public static String[] HOUSE_LIABILITY_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_HOUSE_LIABILITIES_MSME
    };
    ...
    public static int[] HOUSE_LIABILITY_MODULE_ICONS_AHL = {
            R.drawable.ic_home_black_24dp
    };

    // TODO: HOUSE ASSETS AHL
    public static String[] HOUSE_ASSETS_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_HOUSE_ASSETS_MSME
    };

    public static String[] HOUSE_ASSETS_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_HOUSE_ASSETS_AHL
    };
    public static String[] HOUSE_ASSETS_MODULE_SCREEN_NUMBERS_PHL = {
            SCREEN_N0_HOUSE_ASSETS_PHL
    };

    public static int[] HOUSE_ASSETS_MODULE_ICONS_AHL = {
            R.drawable.ic_location_city_black_24dp
    };

    // TODO: BUSINESS LIABILITY IL
    public static String[] BUSINESS_LIABILITY_MODULE_SCREEN_NAMES_IL = {
            SCREEN_NAME_BUSINESS_LIABILITIES
    };

    public static String[] BUSINESS_LIABILITY_MODULE_SCREEN_NUMBERS_IL = {
            SCREEN_N0_BUSINESS_LIABILITIES
    };

    public static int[] BUSINESS_LIABILITY_MODULE_ICONS_IL = {
            R.drawable.ic_business_center_black_24dp
    };

    // TODO: BUSINESS LIABILITY MSME
    public static String[] BUSINESS_LIABILITY_MODULE_SCREEN_NAMES_MSME = {
            SCREEN_NAME_BUSINESS_LIABILITIES_MSME
    };

    public static String[] BUSINESS_LIABILITY_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_BUSINESS_LIABILITIES_MSME
    };

    public static int[] BUSINESS_LIABILITY_MODULE_ICONS_MSME = {
            R.drawable.ic_business_center_black_24dp
    };

    // TODO: BUSINESS LIABILITY AHL
    public static String[] BUSINESS_LIABILITY_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_BUSINESS_LIABILITIES_MSME
    };

    public static String[] BUSINESS_LIABILITY_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_BUSINESS_LIABILITIES_AHL
    };
    public static String[] BUSINESS_LIABILITY_MODULE_SCREEN_NUMBERS_PHL = {
            SCREEN_N0_BUSINESS_LIABILITIES_PHL
    };
    public static int[] BUSINESS_LIABILITY_MODULE_ICONS_AHL = {
            R.drawable.ic_business_center_black_24dp
    };
    ...
    public static String[] BUSINESS_ASSETS_MODULE_SCREEN_NUMBERS_IL = {
            SCREEN_N0_BUSINESS_ASSETS
    };

    public static int[] BUSINESS_ASSETS_MODULE_ICONS_IL = {
            R.drawable.ic_location_city_black_24dp
    };
    ...
    public static String[] BUSINESS_ASSETS_MODULE_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_BUSINESS_ASSETS_MSME
    };

    public static int[] BUSINESS_ASSETS_MODULE_ICONS_MSME = {
            R.drawable.ic_location_city_black_24dp
    };

    // TODO: BUSINESS ASSETS AHL
    public static String[] BUSINESS_ASSETS_MODULE_SCREEN_NAMES_AHL = {
            SCREEN_NAME_BUSINESS_ASSETS_MSME
    };

    public static String[] BUSINESS_ASSETS_MODULE_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_BUSINESS_ASSETS_AHL
    };
    public static String[] BUSINESS_ASSETS_MODULE_SCREEN_NUMBERS_PHL = {
            SCREEN_N0_BUSINESS_ASSETS_PHL
    };

    public static int[] BUSINESS_ASSETS_MODULE_ICONS_AHL = {
            R.drawable.ic_location_city_black_24dp
    };

    // TODO: MANUFACTURING BUSINESS INCOME IL
    public static String[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NAMES_IL = {
            SCREEN_NAME_DECLARED_SALES_WEEKLY,
//            SCREEN_NAME_DECLARED_SALES_YEARLY,
//            SCREEN_NAME_PRODUCT_ESTIMATE,
            SCREEN_NAME_PURCHASE_ANALYSIS,
            SCREEN_NAME_OPERATING_EXPENSE,
            SCREEN_NAME_SUMMARY
    };

    public static String[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NUMBERS_IL = {
            SCREEN_N0_MANUFACTURING_DECALRED_SALES_WEEKLY,
//            SCREEN_N0_MANUFACTURING_DECALRED_SALES_YEARLY,
//            SCREEN_N0_MANUFACTURING_PRODUCT_ESTIMATE,
            SCREEN_N0_MANUFACTURING_PURCHASE_ANALYSIS,
            SCREEN_N0_MANUFACTURING_OPERATING_EXPENSE,
            SCREEN_N0_MANUFACTURING_SUMMARY
    };

    public static int[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NAMES_ICONS_IL = {
            R.drawable.ic_attach_money_black_24dp,
...
//            R.drawable.ic_collections_black_24dp,
    ...
    // TODO: MANUFACTURING BUSINESS INCOME MSME
    public static String[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NAMES_MSME = {
            SCREEN_NAME_DECLARED_SALES_WEEKLY,
            SCREEN_NAME_BANKING_HISTORY_MSME,
//            SCREEN_NAME_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_NAME_SALES_BILLS_MSME,
//            SCREEN_NAME_SALES_BILLS_DETAIL_MSME,
            SCREEN_NAME_PURCHASE_BILLS_MSME,
//            SCREEN_NAME_PURCHASE_BILLS_DETAIL_MSME,
            SCREEN_NAME_GST_MSME,
            SCREEN_NAME_ITR_MSME,
//            SCREEN_NAME_ITR_DETAIL_MSME,
            SCREEN_NAME_PRODUCT_ESTIMATE_MSME,
            SCREEN_NAME_PRODUCT_ESTIMATE_DETAIL_MSME,
//            SCREEN_NAME_PRODUCT_RAW_MATERIAL_MSME,
//            SCREEN_NAME_SERVICE_ESTIMATE_MSME,
//            SCREEN_NAME_SERVICE_ESTIMATE_DETAIL_MSME,
//            SCREEN_NAME_SERVICE_RAW_MATERIAL_MSME,
            SCREEN_NAME_DIRECT_BUSINESS_EXPENSE_MSME,
            SCREEN_NAME_OPERATING_EXPENSE_MSME,
            SCREEN_NAME_INCOME_ASSESSMENT_SUMMARY_MSME
    };

    public static String[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_DECALRED_SALES_WEEKLY_MSME,
            SCREEN_N0_BANKING_HISTORY_MSME,
//            SCREEN_N0_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_N0_SALES_BILLS_MSME,
//            SCREEN_N0_SALES_BILLS_DETAIL_MSME,
            SCREEN_N0_PURCHASE_BILLS_MSME,
//            SCREEN_N0_PURCHASE_BILLS_DETAIL_MSME,
            SCREEN_N0_GST_MSME,
            SCREEN_N0_ITR_MSME,
//            SCREEN_N0_ITR_DETAIL_MSME,
            SCREEN_N0_PRODUCT_ESTIMATE_MSME,
            SCREEN_N0_PRODUCT_ESTIMATE_DETAIL_MSME,
//            SCREEN_N0_PRODUCT_RAW_MATERIAL_MSME,
//            SCREEN_N0_SERVICE_ESTIMATE_MSME,
//            SCREEN_N0_SERVICE_ESTIMATE_DETAIL_MSME,
//            SCREEN_N0_SERVICE_RAW_MATERIAL_MSME,
            SCREEN_N0_DIRECT_BUSINESS_EXPENSE_MSME,
            SCREEN_N0_OPERATING_EXPENSE_MSME,
            SCREEN_N0_INCOME_ASSESSMENT_SUMMARY_MSME
    };

    public static int[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NAMES_ICONS_MSME = {
            R.drawable.ic_attach_money_black_24dp,
            R.drawable.ic_monetization_on_black_24dp,
//            R.drawable.ic_collections_black_24dp,
            R.drawable.ic_add_shopping_cart_black_24dp,
...
//            R.drawable.ic_playlist_add_check_black_24dp,
            R.drawable.ic_business_proof_24,
            R.drawable.ic_business_add_proof_24,
//            R.drawable.ic_playlist_add_check_black_24dp,
            R.drawable.ic_business_proof2_24,
            R.drawable.ic_add,
//            R.drawable.ic_playlist_add_check_black_24dp,
//            R.drawable.ic_playlist_add_check_black_24dp,
//            R.drawable.ic_playlist_add_check_black_24dp,
//            R.drawable.ic_playlist_add_check_black_24dp,
    ...
    // TODO: MANUFACTURING BUSINESS INCOME AHL
    public static String[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NAMES_AHL = {
            SCREEN_NAME_DECLARED_SALES_WEEKLY,
            SCREEN_NAME_BANKING_HISTORY_MSME,
//            SCREEN_NAME_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_NAME_SALES_BILLS_MSME,
...
//            SCREEN_NAME_SERVICE_RAW_MATERIAL_MSME,
    ...
    public static String[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_DECALRED_SALES_WEEKLY_AHL,
            SCREEN_N0_BANKING_HISTORY_AHL,
//            SCREEN_N0_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_N0_SALES_BILLS_AHL,
//            SCREEN_N0_SALES_BILLS_DETAIL_MSME,
            SCREEN_N0_PURCHASE_BILLS_AHL,
//            SCREEN_N0_PURCHASE_BILLS_DETAIL_MSME,
            SCREEN_N0_GST_AHL,
            SCREEN_N0_ITR_AHL,
//            SCREEN_N0_ITR_DETAIL_MSME,
            SCREEN_N0_PRODUCT_ESTIMATE_AHL,
            SCREEN_N0_PRODUCT_ESTIMATE_DETAIL_AHL,
//            SCREEN_N0_PRODUCT_RAW_MATERIAL_MSME,
//            SCREEN_N0_SERVICE_ESTIMATE_MSME,
//            SCREEN_N0_SERVICE_ESTIMATE_DETAIL_MSME,
//            SCREEN_N0_SERVICE_RAW_MATERIAL_MSME,
            SCREEN_N0_DIRECT_BUSINESS_EXPENSE_AHL,
            SCREEN_N0_OPERATING_EXPENSE_AHL,
            SCREEN_N0_INCOME_ASSESSMENT_SUMMARY_AHL
    };

    public static String[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NUMBERS_PHL = {
            SCREEN_N0_DECALRED_SALES_WEEKLY_PHL,
            SCREEN_N0_BANKING_HISTORY_PHL,
//            SCREEN_N0_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_N0_SALES_BILLS_PHL,
//            SCREEN_N0_SALES_BILLS_DETAIL_MSME,
            SCREEN_N0_PURCHASE_BILLS_PHL,
//            SCREEN_N0_PURCHASE_BILLS_DETAIL_MSME,
            SCREEN_N0_GST_PHL,
            SCREEN_N0_ITR_PHL,
//            SCREEN_N0_ITR_DETAIL_MSME,
            SCREEN_N0_PRODUCT_ESTIMATE_PHL,
            SCREEN_N0_PRODUCT_ESTIMATE_DETAIL_PHL,
//            SCREEN_N0_PRODUCT_RAW_MATERIAL_MSME,
//            SCREEN_N0_SERVICE_ESTIMATE_MSME,
//            SCREEN_N0_SERVICE_ESTIMATE_DETAIL_MSME,
//            SCREEN_N0_SERVICE_RAW_MATERIAL_MSME,
            SCREEN_N0_DIRECT_BUSINESS_EXPENSE_PHL,
            SCREEN_N0_OPERATING_EXPENSE_PHL,
            SCREEN_N0_INCOME_ASSESSMENT_SUMMARY_PHL
    };

    public static int[] MANUFACTURE_BUSINESS_INCOME_SCREEN_NAMES_ICONS_AHL = {
            R.drawable.ic_attach_money_black_24dp,
            R.drawable.ic_monetization_on_black_24dp,
//            R.drawable.ic_collections_black_24dp,
            R.drawable.ic_add_shopping_cart_black_24dp,
...
//            R.drawable.ic_playlist_add_check_black_24dp,
    ...
    // TODO: SERVICE BUSINESS INCOME MSME
    public static String[] SERVICE_BUSINESS_INCOME_SCREEN_NAMES_MSME = {
            SCREEN_NAME_DECLARED_SALES_WEEKLY,
            SCREEN_NAME_BANKING_HISTORY_MSME,
//            SCREEN_NAME_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_NAME_SALES_BILLS_MSME,
...
//            SCREEN_NAME_SERVICE_RAW_MATERIAL_MSME,
    ...
    public static String[] SERVICE_BUSINESS_INCOME_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_DECALRED_SALES_WEEKLY_MSME,
            SCREEN_N0_BANKING_HISTORY_MSME,
//            SCREEN_N0_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_N0_SALES_BILLS_MSME,
...
//            SCREEN_N0_SERVICE_RAW_MATERIAL_MSME,
    ...
    public static int[] SERVICE_BUSINESS_INCOME_SCREEN_NAMES_ICONS_MSME = {
            R.drawable.ic_attach_money_black_24dp,
            R.drawable.ic_monetization_on_black_24dp,
//            R.drawable.ic_collections_black_24dp,
            R.drawable.ic_add_shopping_cart_black_24dp,
...
//            R.drawable.ic_playlist_add_check_black_24dp,
    ...
    // TODO: SERVICE BUSINESS INCOME AHL
    public static String[] SERVICE_BUSINESS_INCOME_SCREEN_NAMES_AHL = {
            SCREEN_NAME_DECLARED_SALES_WEEKLY,
            SCREEN_NAME_BANKING_HISTORY_MSME,
//            SCREEN_NAME_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_NAME_SALES_BILLS_MSME,
...
//            SCREEN_NAME_SERVICE_RAW_MATERIAL_MSME,
    ...
    public static String[] SERVICE_BUSINESS_INCOME_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_DECALRED_SALES_WEEKLY_AHL,
            SCREEN_N0_BANKING_HISTORY_AHL,
//            SCREEN_N0_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_N0_SALES_BILLS_AHL,
...
//            SCREEN_N0_PRODUCT_ESTIMATE_DETAIL_MSME,
//            SCREEN_N0_PRODUCT_RAW_MATERIAL_MSME,
            SCREEN_N0_SERVICE_ESTIMATE_AHL,
            SCREEN_N0_SERVICE_ESTIMATE_DETAIL_AHL,
//            SCREEN_N0_SERVICE_RAW_MATERIAL_MSME,
            SCREEN_N0_DIRECT_BUSINESS_EXPENSE_AHL,
            SCREEN_N0_OPERATING_EXPENSE_AHL,
            SCREEN_N0_INCOME_ASSESSMENT_SUMMARY_AHL
    };
    public static String[] SERVICE_BUSINESS_INCOME_SCREEN_NUMBERS_PHL = {
            SCREEN_N0_DECALRED_SALES_WEEKLY_PHL,
            SCREEN_N0_BANKING_HISTORY_PHL,
//            SCREEN_N0_MONTHLY_TRANSACTION_DETAIL_MSME,
            SCREEN_N0_SALES_BILLS_PHL,
...
//            SCREEN_N0_PRODUCT_ESTIMATE_DETAIL_MSME,
//            SCREEN_N0_PRODUCT_RAW_MATERIAL_MSME,
            SCREEN_N0_SERVICE_ESTIMATE_PHL,
            SCREEN_N0_SERVICE_ESTIMATE_DETAIL_PHL,
//            SCREEN_N0_SERVICE_RAW_MATERIAL_MSME,
            SCREEN_N0_DIRECT_BUSINESS_EXPENSE_PHL,
            SCREEN_N0_OPERATING_EXPENSE_PHL,
            SCREEN_N0_INCOME_ASSESSMENT_SUMMARY_PHL
    ...
    public static int[] SERVICE_BUSINESS_INCOME_SCREEN_NAMES_ICONS_AHL = {
            R.drawable.ic_attach_money_black_24dp,
            R.drawable.ic_monetization_on_black_24dp,
//            R.drawable.ic_collections_black_24dp,
            R.drawable.ic_add_shopping_cart_black_24dp,
...
//            R.drawable.ic_playlist_add_check_black_24dp,
    ...
    // TODO: HOUSE ASSETS FIXED ASSET TYPE SCREEN NAMES
    public static String[] HOUSE_ASSETS_FIXED_ASSET_TYPE_SCREEN_NAMES = {
            SCREEN_NAME_HOUSE_ASSETS_BUILDING_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_LAND_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_OPEN_PLOT_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_TWO_WHEELER_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_CAR_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_VEHICLES_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_PLANT_MACHINERY_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_UTILITIES_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_LIVESTOCK_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_EQUIPMENT_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_TELEVISION_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_OTHERS_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_FURNITURE_DETAIL_MSME,
            SCREEN_NAME_HOUSE_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME
    };

    // TODO: BUSINESS ASSETS FIXED ASSET TYPE SCREEN NAMES
    public static String[] BUSINESS_ASSETS_FIXED_ASSET_TYPE_SCREEN_NAMES = {
            SCREEN_NAME_BUSINESS_ASSETS_BUILDING_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_LAND_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_OPEN_PLOT_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_TWO_WHEELER_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_CAR_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_VEHICLES_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_PLANT_MACHINERY_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_UTILITIES_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_LIVESTOCK_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_EQUIPMENT_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_TELEVISION_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_OTHERS_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_FURNITURE_DETAIL_MSME,
            SCREEN_NAME_BUSINESS_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME
    };

    // TODO: MORTGAGE FIXED ASSET TYPE SCREEN NAMES
    public static String[] MORTGAGE_FIXED_ASSET_TYPE_SCREEN_NAMES = {
            SCREEN_NAME_MORTGAGE_BUILDING_MSME,
            SCREEN_NAME_MORTGAGE_LAND_MSME,
            SCREEN_NAME_MORTGAGE_OPEN_PLOT_MSME,
    };


    public static String[] getScreenNameAndNumberForHouseAssets(String spinnerItem) {
        String[] screenAndNumber = new String[2];
        try {
            if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_BUILDING)) { // TODO: building
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_BUILDING_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_BUILDING_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_LAND)) { // TODO: land
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_LAND_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_LAND_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_OPEN_PLOT)) { // TODO: open plot
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_OPEN_PLOT_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_OPEN_PLOT_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_TWO_WHEELER)) { // TODO: two wheeler
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_TWO_WHEELER_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_TWO_WHEELER_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_CAR)) { // TODO: car
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_CAR_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_CAR_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_VEHICLE)) { // TODO: vehicle
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_VEHICLES_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_VEHICLES_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_PLANT_AND_MACHINERY)) { // TODO: plant and machinery
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_PLANT_MACHINERY_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_PLANT_MACHINERY_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_UTILITIES)) { // TODO: utilities
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_UTILITIES_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_UTILITIES_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_LIVESTOCK)) { // TODO: livestock
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_LIVESTOCK_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_LIVESTOCK_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_EQUIPMENT)) { // TODO: equipment
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_EQUIPMENT_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_EQUIPMENT_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_TV)) { // TODO: tv
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_TELEVISION_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_TELEVISION_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_OTHERS)) { // TODO: others
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_OTHERS_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_OTHERS_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_FURNITURE)) { // TODO: furniture
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_FURNITURE_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_FURNITURE_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_COMMERCIAL_VEHICLE)) { // TODO: commercial vehicle
                screenAndNumber[0] = SCREEN_NAME_HOUSE_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_HOUSE_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME;
            }

        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return screenAndNumber;
    }

    public static String[] getScreenNameAndNumberForBusinessAssets(String spinnerItem) {
        String[] screenAndNumber = new String[2];
        try {
            if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_BUILDING)) { // TODO: building
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_BUILDING_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_BUILDING_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_LAND)) { // TODO: land
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_LAND_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_LAND_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_OPEN_PLOT)) { // TODO: open plot
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_OPEN_PLOT_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_OPEN_PLOT_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_TWO_WHEELER)) { // TODO: two wheeler
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_TWO_WHEELER_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_TWO_WHEELER_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_CAR)) { // TODO: car
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_CAR_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_CAR_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_VEHICLE)) { // TODO: vehicle
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_VEHICLES_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_VEHICLES_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_PLANT_AND_MACHINERY)) { // TODO: plant and machinery
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_PLANT_MACHINERY_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_PLANT_MACHINERY_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_UTILITIES)) { // TODO: utilities
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_UTILITIES_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_UTILITIES_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_LIVESTOCK)) { // TODO: livestock
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_LIVESTOCK_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_LIVESTOCK_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_EQUIPMENT)) { // TODO: equipment
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_EQUIPMENT_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_EQUIPMENT_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_TV)) { // TODO: tv
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_TELEVISION_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_TELEVISION_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_OTHERS)) { // TODO: others
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_OTHERS_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_OTHERS_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_FURNITURE)) { // TODO: furniture
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_FURNITURE_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_FURNITURE_DETAIL_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_COMMERCIAL_VEHICLE)) { // TODO: commercial vehicle
                screenAndNumber[0] = SCREEN_NAME_BUSINESS_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME;
                screenAndNumber[1] = SCREEN_N0_BUSINESS_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME;
            }
    ...
    public static String[] getScreenNameAndNumberForMortgageFixedAssets(String spinnerItem) {
        String[] screenAndNumber = new String[2];
        try {
            if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_BUILDING)) { // TODO: building
                screenAndNumber[0] = SCREEN_NAME_MORTGAGE_BUILDING_MSME;
                screenAndNumber[1] = SCREEN_NO_MORTGAGE_BUILDING_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_LAND)) { // TODO: land
                screenAndNumber[0] = SCREEN_NAME_MORTGAGE_LAND_MSME;
                screenAndNumber[1] = SCREEN_NO_MORTGAGE_LAND_MSME;
            } else if (spinnerItem.equalsIgnoreCase(SPINNER_ITEM_FIELD_NAME_OPEN_PLOT)) { // TODO: open plot
                screenAndNumber[0] = SCREEN_NAME_MORTGAGE_OPEN_PLOT_MSME;
                screenAndNumber[1] = SCREEN_NO_MORTGAGE_OPEN_PLOT_MSME;
            }
    ...
    public static String getScreenNumberForMortgageFixedAssets(String screenName) {
        String screenAndNumber = "";
        try {
            if (!TextUtils.isEmpty(screenName)) {
                if (screenName.equalsIgnoreCase(SCREEN_NAME_MORTGAGE_BUILDING_MSME)) { // TODO: building
                    screenAndNumber = SCREEN_NO_MORTGAGE_BUILDING_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_MORTGAGE_LAND_MSME)) { // TODO: land
                    screenAndNumber = SCREEN_NO_MORTGAGE_LAND_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_MORTGAGE_OPEN_PLOT_MSME)) { // TODO: open plot
                    screenAndNumber = SCREEN_NO_MORTGAGE_OPEN_PLOT_MSME;
                }
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public static String getScreenNumberForHouseAssets(String screenName) {
        String screenAndNumber = "";
        try {
            if (!TextUtils.isEmpty(screenName)) {
                if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_BUILDING_DETAIL_MSME)) { // TODO: building
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_BUILDING_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_LAND_DETAIL_MSME)) { // TODO: land
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_LAND_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_OPEN_PLOT_DETAIL_MSME)) { // TODO: open plot
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_OPEN_PLOT_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_TWO_WHEELER_DETAIL_MSME)) { // TODO: two wheeler
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_TWO_WHEELER_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_CAR_DETAIL_MSME)) { // TODO: car
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_CAR_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_VEHICLES_DETAIL_MSME)) { // TODO: vehicle
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_VEHICLES_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_PLANT_MACHINERY_DETAIL_MSME)) { // TODO: plant and machinery
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_PLANT_MACHINERY_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_UTILITIES_DETAIL_MSME)) { // TODO: utilities
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_UTILITIES_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_LIVESTOCK_DETAIL_MSME)) { // TODO: livestock
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_LIVESTOCK_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_EQUIPMENT_DETAIL_MSME)) { // TODO: equipment
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_EQUIPMENT_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_TELEVISION_DETAIL_MSME)) { // TODO: tv
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_TELEVISION_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_OTHERS_DETAIL_MSME)) { // TODO: others
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_OTHERS_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_FURNITURE_DETAIL_MSME)) { // TODO: furniture
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_FURNITURE_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_HOUSE_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME)) { // TODO: commercial vehicles
                    screenAndNumber = SCREEN_N0_HOUSE_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME;
                }
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public static String getScreenNumberForBusinessAssets(String screenName) {
        String screenAndNumber = "";
        try {
            if (!TextUtils.isEmpty(screenName)) {
                if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_BUILDING_DETAIL_MSME)) { // TODO: building
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_BUILDING_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_LAND_DETAIL_MSME)) { // TODO: land
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_LAND_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_OPEN_PLOT_DETAIL_MSME)) { // TODO: open plot
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_OPEN_PLOT_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_TWO_WHEELER_DETAIL_MSME)) { // TODO: two wheeler
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_TWO_WHEELER_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_CAR_DETAIL_MSME)) { // TODO: car
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_CAR_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_VEHICLES_DETAIL_MSME)) { // TODO: vehicle
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_VEHICLES_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_PLANT_MACHINERY_DETAIL_MSME)) { // TODO: plant and machinery
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_PLANT_MACHINERY_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_UTILITIES_DETAIL_MSME)) { // TODO: utilities
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_UTILITIES_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_LIVESTOCK_DETAIL_MSME)) { // TODO: livestock
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_LIVESTOCK_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_EQUIPMENT_DETAIL_MSME)) { // TODO: equipment
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_EQUIPMENT_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_TELEVISION_DETAIL_MSME)) { // TODO: tv
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_TELEVISION_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_OTHERS_DETAIL_MSME)) { // TODO: others
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_OTHERS_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_FURNITURE_DETAIL_MSME)) { // TODO: furniture
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_FURNITURE_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_BUSINESS_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME)) { // TODO: commercial vehicle
                    screenAndNumber = SCREEN_N0_BUSINESS_ASSETS_COMMERCIAL_VEHICLE_DETAIL_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_CASH_BUSINESS_ASSETS_MSME)) { // TODO: cash
                    screenAndNumber = SCREEN_N0_CASH_BUSINESS_ASSETS_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_SAVINGS_CHITS_BUSINESS_ASSETS_MSME)) { // TODO: savings/chits
                    screenAndNumber = SCREEN_N0_SAVING_CHITS_BUSINESS_ASSETS_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_DEPOSITS_BUSINESS_ASSETS_BONDS_MSME)) { // TODO: deposits & bonds
                    screenAndNumber = SCREEN_N0_DEPOSITS_BONDS_BUSINESS_ASSETS_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_INSURANCE_BUSINESS_ASSETS_MSME)) { // TODO: insurance
                    screenAndNumber = SCREEN_N0_INSURANCE_BUSINESS_ASSETS_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_INVENTORY_BUSINESS_ASSETS_MSME)) { // TODO: inventory
                    screenAndNumber = SCREEN_N0_INVENTORY_BUSINESS_ASSETS_MSME;
                } else if (screenName.equalsIgnoreCase(SCREEN_NAME_RECEIVABLES_BUSINESS_ASSETS_MSME)) { // TODO: receivables
                    screenAndNumber = SCREEN_N0_RECEIVABLES_BUSINESS_ASSETS_MSME;
                }
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    // TODO: COLD CALLING MSME
    public static String[] COLD_CALLING_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_COLD_CALLING
    };
    public static String[] COLD_CALLING_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_COLD_CALLING_MSME
    };
    public static int[] COLD_CALLING_TAB_ICONS_MSME = {
            R.drawable.ic_streetview_black_24dp
    };

    // TODO: COLD CALLING MSME
    public static String[] SALES_TOOL_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_SALES_TOOL
    };
    public static String[] SALES_TOOL_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_SALES_TOOL_MSME
    };
    public static int[] SALES_TOOL_TAB_ICONS_MSME = {
            R.drawable.ic_streetview_black_24dp
    };

    // TODO: COLD CALLING AHL
    public static String[] COLD_CALLING_TAB_SCREEN_NAMES_AHL = {
            SCREEN_NAME_COLD_CALLING
    };
    public static String[] COLD_CALLING_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_COLD_CALLING_AHL
    };
    public static String[] COLD_CALLING_TAB_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_COLD_CALLING_PHL
    };
    public static int[] COLD_CALLING_TAB_ICONS_AHL = {
            R.drawable.ic_streetview_black_24dp
    };

    // TODO: COLLECTION MSME
    public static String[] COLLECTION_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_COLLECTION
    };
    public static String[] COLLECTION_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_COLLECTION_MSME
    };
    public static int[] COLLECTION_TAB_ICONS_MSME = {
            R.drawable.ic_streetview_black_24dp
    };
    ...
    public static String[] COLLECTION_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_COLLECTION_AHL
    };
    ...
    // TODO: LEAD JLG
    public static String[] LEAD_TAB_SCREEN_NAMES_JLG = {
            SCREEN_NAME_LEAD
    };
    public static String[] LEAD_TAB_SCREEN_NUMBERS_JLG = {
            SCREEN_N0_LEAD
    };
    public static int[] LEAD_TAB_ICONS_JLG = {
            R.drawable.ic_streetview_black_24dp
    };

    // TODO: LEAD IL
    public static String[] LEAD_TAB_SCREEN_NAMES_IL = {
            SCREEN_NAME_LEAD
    };
    public static String[] LEAD_TAB_SCREEN_NUMBERS_IL = {
            SCREEN_N0_LEAD_IL
    };
    public static int[] LEAD_TAB_ICONS_IL = {
            R.drawable.ic_streetview_black_24dp
    };


    // TODO: LEAD MSME
    public static String[] LEAD_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_LEAD
    };
    public static String[] LEAD_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_LEAD_MSME
    };
    public static int[] LEAD_TAB_ICONS_MSME = {
            R.drawable.ic_streetview_black_24dp
    };
    ...
    public static String[] LEAD_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_LEAD_AHL
    };
    ...
    public static String[] LEAD_TAB_SCREEN_NUMBERS_TW = {
            SCREEN_N0_LEAD
    };
    public static int[] LEAD_TAB_ICONS_TW = {
            R.drawable.ic_streetview_black_24dp
    };
...
//            SCREEN_NAME_FINANCIAL_RATIOS,
    ...
    public static String[] LOAN_PROPOSAL_PD_TAB_SCREEN_NUMBERS_IL = {
            SCREEN_NO_SUMMARY_LOAN_PROPOSAL_IL,
//            SCREEN_NO_SURPLUS_IL,
//            SCREEN_NO_FINANCIAL_RATIOS_IL,
            SCREEN_NO_LOAN_PROPOSAL_MODULE_IL
    };

    public static int[] LOAN_PROPOSAL_PD_TAB_ICONS_IL = {
            R.drawable.ic_streetview_black_24dp,
//            R.drawable.ic_streetview_black_24dp,
//            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_streetview_black_24dp
    ...
    // TODO: LOAN PROPOSAL SCREEN NAMES MSME
    public static String[] LOAN_PROPOSAL_PD_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_SUMMARY_LOAN_PROPOSAL,
            SCREEN_NAME_SURPLUS,
            SCREEN_NAME_FINANCIAL_RATIOS,
            SCREEN_NAME_LOAN_PROPOSAL
    ...
    public static String[] LOAN_PROPOSAL_PD_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_NO_SUMMARY_LOAN_PROPOSAL_IL,
            SCREEN_NO_SURPLUS_IL,
            SCREEN_NO_FINANCIAL_RATIOS_IL,
            SCREEN_NO_LOAN_PROPOSAL_MODULE_IL
    ...
    public static int[] LOAN_PROPOSAL_PD_TAB_ICONS_MSME = {
            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_streetview_black_24dp
    ...
    public static String[] LOAN_PROPOSAL_PD_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_NO_SUMMARY_LOAN_PROPOSAL_IL,
            SCREEN_NO_SURPLUS_IL,
            SCREEN_NO_FINANCIAL_RATIOS_IL,
            SCREEN_NO_LOAN_PROPOSAL_MODULE_IL
    };
    public static String[] LOAN_PROPOSAL_PD_TAB_SCREEN_NUMBERS_PHL = {
            SCREEN_NO_SUMMARY_LOAN_PROPOSAL_IL,
            SCREEN_NO_SURPLUS_IL,
            SCREEN_NO_FINANCIAL_RATIOS_IL,
            SCREEN_NO_LOAN_PROPOSAL_MODULE_IL
    ...
    public static int[] LOAN_PROPOSAL_PD_TAB_ICONS_AHL = {
            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_streetview_black_24dp
    ...
    // TODO: DECISIONS IL
    public static String[] DECISION_TAB_SCREEN_NAMES_IL = {
            SCREEN_NAME_OBSERVATIONS
    };
    public static String[] DECISION_TAB_SCREEN_NUMBERS_IL = {
            SCREEN_NO_OBSERVATION_IL
    };
    public static int[] DECISION_TAB_ICONS_IL = {
            R.drawable.ic_streetview_black_24dp
    };

    // TODO: DECISIONS MSME
    public static String[] DECISION_TAB_SCREEN_NAMES_MSME_WITHOUT_MORTAGE = {
            SCREEN_NAME_LOAN_INFORMATION_MSME,
            SCREEN_NAME_SUBJECT_TO_CONDITIONS_MSME,
            SCREEN_NAME_HYPOTHECATION_MSME,
            SCREEN_NAME_CASH_FLOW_SUMMARY_MSME,
            SCREEN_NAME_LOAN_APPROVAL_MSME
    };
    // TODO: DECISIONS MSME
    public static String[] DECISION_TAB_SCREEN_NAMES_MSME = {
            SCREEN_NAME_LOAN_INFORMATION_MSME,
            SCREEN_NAME_MORTGAGE_MSME,
            SCREEN_NAME_SUBJECT_TO_CONDITIONS_MSME,
            SCREEN_NAME_HYPOTHECATION_MSME,
            SCREEN_NAME_CASH_FLOW_SUMMARY_MSME,
            SCREEN_NAME_LOAN_APPROVAL_MSME
    };
    public static String[] DECISION_TAB_SCREEN_NUMBERS_MSME = {
            SCREEN_N0_DECISIONS_LOAN_INFORMATION_MSME,
            SCREEN_NO_MORTGAGE_MSME,
            SCREEN_N0_DECISIONS_SUBJECT_TO_CONDITIONS_MSME,
            SCREEN_N0_DECISIONS_HYPOTHECATION_MSME,
            SCREEN_N0_CASH_FLOW_SUMMARY_MSME,
            SCREEN_N0_LOAN_APPROVAL_MSME
    };
    public static int[] DECISION_TAB_ICONS_MSME = {
            R.drawable.ic_card_travel_black_24dp,
            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_transfer_within_a_station_24dp,
            R.drawable.ic_playlist_add_check_black_24dp,
    ...
    // TODO: DECISIONS AHL
    public static String[] DECISION_TAB_SCREEN_NAMES_AHL = {
            SCREEN_NAME_LOAN_INFORMATION_MSME,
            SCREEN_NAME_MORTGAGE_MSME,
            SCREEN_NAME_SUBJECT_TO_CONDITIONS_MSME,
            SCREEN_NAME_HYPOTHECATION_MSME,
    ...
    public static String[] DECISION_TAB_SCREEN_NUMBERS_AHL = {
            SCREEN_N0_DECISIONS_LOAN_INFORMATION_AHL,
            SCREEN_NO_MORTGAGE_AHL,
            SCREEN_N0_DECISIONS_SUBJECT_TO_CONDITIONS_AHL,
            SCREEN_N0_DECISIONS_HYPOTHECATION_AHL,
            SCREEN_N0_CASH_FLOW_SUMMARY_AHL,
            SCREEN_N0_LOAN_APPROVAL_AHL
    };
    public static String[] DECISION_TAB_SCREEN_NUMBERS_PHL = {
            SCREEN_N0_DECISIONS_LOAN_INFORMATION_PHL,
            SCREEN_NO_MORTGAGE_PHL,
            SCREEN_N0_DECISIONS_SUBJECT_TO_CONDITIONS_PHL,
            SCREEN_N0_DECISIONS_HYPOTHECATION_PHL,
            SCREEN_N0_CASH_FLOW_SUMMARY_PHL,
            SCREEN_N0_LOAN_APPROVAL_PHL
    };

    public static int[] DECISION_TAB_ICONS_AHL = {
            R.drawable.ic_card_travel_black_24dp,
            R.drawable.ic_streetview_black_24dp,
            R.drawable.ic_transfer_within_a_station_24dp,
            R.drawable.ic_playlist_add_check_black_24dp,
    ...
    public static ScreenDetailsDTO getScreenDetailsByScreenId(String screenId, String moduleType){
        ...
        try{
            ...
            // TODO: LOAN PROPOSAL WOTH NOMINEE DETAILS MSME
