...
public class CourseDetailsFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    private static final String TAG = CourseDetailsFragment.class.getCanonicalName();

    private CourseDetailsFragment.OnFragmentInteractionListener mListener;
    String leadState = "";
    ...
    public static CourseDetailsFragment newInstance(String loanType, String clientId, String projectId, String productId,
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(CourseDetailsFragment.this);
    }
