            ...
            Observer observer = new Observer() {
                ...
                public void onChanged(@Nullable Object o) {
                    ...
                    if(list!=null && list.size()>0) {
                        pincodeMasterDataForLoanProposal(list,CLIENT_ID);
                        getNegitiveProfileListFromLoanProposal(list,CLIENT_ID,PRODUCT_ID);
                        getProductLoanSchemeMasterFromServer(list);
                    }
                }
            };
