...
public class ApplicantRegulatoryFieldsFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    ...
    private ApplicantRegulatoryFieldsFragment.OnFragmentInteractionListener mListener;
    String leadState = "";

    public ApplicantRegulatoryFieldsFragment() {

    }

    // TODO: Rename and change types and number of parameters
    public static ApplicantRegulatoryFieldsFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                                String screenNo, String screenName, String userId, String moduleType) {
        ApplicantRegulatoryFieldsFragment fragment = new ApplicantRegulatoryFieldsFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(ApplicantRegulatoryFieldsFragment.this);
    }
        ...
        try {
            ...
            Observer observer = new Observer() {
                ...
                public void onChanged(@Nullable Object o) {
                    ...
                    updateChildViewVisibility(list);
