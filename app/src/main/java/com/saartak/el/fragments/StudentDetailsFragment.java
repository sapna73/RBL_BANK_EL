...
public class StudentDetailsFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    private static final String TAG = StudentDetailsFragment.class.getCanonicalName();

    private StudentDetailsFragment.OnFragmentInteractionListener mListener;
    String leadState = "";
    ...
    public static StudentDetailsFragment newInstance(String loanType, String clientId, String projectId, String productId,
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(StudentDetailsFragment.this);
    }
