...
public class CoApplicantPANDetailsFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    private static final String TAG = CoApplicantPANDetailsFragment.class.getCanonicalName();

    private CoApplicantPANDetailsFragment.OnFragmentInteractionListener mListener;
    String leadState = "";

    public CoApplicantPANDetailsFragment() {

    }

    // TODO: Rename and change types and number of parameters
    public static CoApplicantPANDetailsFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                            String screenNo, String screenName, String userId, String moduleType) {
        CoApplicantPANDetailsFragment fragment = new CoApplicantPANDetailsFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(CoApplicantPANDetailsFragment.this);
    }
