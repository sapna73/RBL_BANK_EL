...
import static com.saartak.el.dynamicui.constants.ParametersConstant.FIELD_TYPE_TEXT_LABEL_WITH_TEXT_BOX;
...
public class CoApplicantRegulatoryFieldsFragment extends LOSBaseFragment implements LOSBaseFragment.DynamiUIinterfacce, HasSupportFragmentInjector, FragmentInterface {
    private static final String TAG = CoApplicantRegulatoryFieldsFragment.class.getCanonicalName();

    private CoApplicantRegulatoryFieldsFragment.OnFragmentInteractionListener mListener;
    String leadState = "";

    public CoApplicantRegulatoryFieldsFragment() {

    }

    // TODO: Rename and change types and number of parameters
    public static CoApplicantRegulatoryFieldsFragment newInstance(String loanType, String clientId, String projectId, String productId,
                                                                String screenNo, String screenName, String userId, String moduleType) {
        CoApplicantRegulatoryFieldsFragment fragment = new CoApplicantRegulatoryFieldsFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDynamiUIinterfacce(CoApplicantRegulatoryFieldsFragment.this);
    }
        ...
        try {
            ...
            Observer observer = new Observer() {
                ...
                public void onChanged(@Nullable Object o) {
                    ...
                    updateChildViewVisibility(list);//tusar
                    getRawDataForParentFragment(SCREEN_NAME, list);
                    setRegulatoryFieldsDropDownByDefaultEmpty(list);
                }
            };
    ...
    private void updateChildViewVisibility(List<DynamicUITable> list) {
        if (list == null) return;
        for (DynamicUITable dynamicUITable : list) {
            if (!TextUtils.isEmpty(dynamicUITable.getFieldType())
                    && (dynamicUITable.getFieldType().equalsIgnoreCase(FIELD_TYPE_TEXT_BOX)
                    || dynamicUITable.getFieldType().equalsIgnoreCase(FIELD_TYPE_TEXT_LABEL_WITH_TEXT_BOX))) {
