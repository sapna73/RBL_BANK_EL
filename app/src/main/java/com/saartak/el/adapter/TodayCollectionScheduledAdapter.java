...
public class TodayCollectionScheduledAdapter extends RecyclerView.Adapter<TodayCollectionScheduledAdapter.ViewHolder> {
    ...
    public TodayCollectionScheduledAdapter(Context context, List<TodayCollectionScheduledTable> individualCenterCollectionList,
