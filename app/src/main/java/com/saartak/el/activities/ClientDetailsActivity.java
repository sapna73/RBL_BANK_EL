...
import com.saartak.el.adapter.MultipleCoApplicantAdapter;
...
import static com.saartak.el.constants.AppConstant.APPLICANT_TAB_SCREEN_NAMES_BUSINESS_IL;
import static com.saartak.el.constants.AppConstant.APPLICANT_TAB_SCREEN_NAMES_IL;
import static com.saartak.el.constants.AppConstant.APPLICANT_TAB_SCREEN_NUMBERS_BUSINESS_IL;
import static com.saartak.el.constants.AppConstant.APPLICANT_TAB_SCREEN_NUMBERS_IL;
import static com.saartak.el.constants.AppConstant.APP_FOLDER;
import static com.saartak.el.constants.AppConstant.CO_APPLICANT_TAB_SCREEN_NAMES_IL;
import static com.saartak.el.constants.AppConstant.CO_APPLICANT_TAB_SCREEN_NUMBERS_IL;
...
import static com.saartak.el.constants.AppConstant.LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NAMES_EL;
import static com.saartak.el.constants.AppConstant.LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NAMES_PHL;
...
import static com.saartak.el.constants.AppConstant.MODULE_TYPE_CO_APPLICANT;
import static com.saartak.el.constants.AppConstant.PARAM_MODULE_TYPE;
import static com.saartak.el.constants.AppConstant.MODULE_TYPE_DOCUMENTS;
...
import static com.saartak.el.dynamicui.constants.ParametersConstant.TAG_NAME_NO_OF_COAPPLICANT;
...
//        rvCoApplicant.addItemDecoration(new MyDividerItemDecoration(this, DividerItemDecoration.HORIZONTAL, 24));
        ...
        try {
            ...
            if (loanType.equalsIgnoreCase(LOAN_NAME_TWL)) {
                viewModel.getScreenEditValidation(CLIENT_ID, WORKFLOW_ID_TWL);
            } else if (loanType.equalsIgnoreCase(LOAN_NAME_EL)) {
                viewModel.getScreenEditValidation(CLIENT_ID, WORKFLOW_ID_EL);
            }
            if (viewModel.getScreenEditValidationResponseTableLiveData() != null) {
                viewModel.getScreenEditValidationResponseTableLiveData().observe(this, screenEditValidationResponseTables -> {
        ...
        try {
            switch (v.getId()) {
                case R.id.ll_applicant:
                    ...
                    applicant.putExtra(PARAM_CURRENT_STAGE, currentStage);
                    applicant.putExtra(PARAM_CURRENT_STAGE_ID, currentStageID);
                ...
                case R.id.ll_co_applicant:
                    ...
                    coapplicant.putExtra(PARAM_CURRENT_STAGE, currentStage);
                    coapplicant.putExtra(PARAM_CURRENT_STAGE_ID, currentStageID);
                ...
                case R.id.ll_business:
                    ...
                    business.putExtra(PARAM_CURRENT_STAGE, currentStage);
                ...
                case R.id.ll_salary:
                    ...
                    salary.putExtra(PARAM_CURRENT_STAGE, currentStage);
                ...
                case R.id.ll_loan_proposal_with_nominee:
                    ...
                    loanProposal.putExtra(PARAM_CURRENT_STAGE, currentStage);
                ...
                case R.id.ll_document_upload:
                    ...
                    intentDocument.putExtra(PARAM_CURRENT_STAGE, currentStage);
                ...
                case R.id.ll_user_consent:
                    ...
                    intentUserConsent.putExtra(PARAM_CURRENT_STAGE, currentStage);
                ...
                case R.id.ll_generate_cibil:
                    ...
                    intentGenerateCibil.putExtra(PARAM_CURRENT_STAGE, currentStage);
                    intentGenerateCibil.putExtra(PARAM_CURRENT_STAGE_ID, currentStageID);

                    SharedPreferences mPrefs = getSharedPreferences("CURRENTSTAGE", 0);
                    SharedPreferences.Editor editor = mPrefs.edit();
                    editor.putString("currentstage", currentStage);
                    editor.putString("currentstageId", currentStageID);
                    editor.commit();
    ...
    public void getRawDataForAllSections() {
        ...
        if (!TextUtils.isEmpty(loanType) && loanType.equalsIgnoreCase(LOAN_NAME_EL)) {
            ...
            if (!TextUtils.isEmpty(moduleType) && moduleType.equalsIgnoreCase(MODULE_TYPE_BUSINESS)) {
                ...
                getRawDataForApplicantSection(Arrays.asList(APPLICANT_TAB_SCREEN_NUMBERS_BUSINESS_IL),
                        Arrays.asList(APPLICANT_TAB_SCREEN_NAMES_BUSINESS_IL), CLIENT_ID, loanType, MODULE_TYPE_APPLICANT);
            }else {
                llBusiness.setVisibility(View.GONE);
                llSalary.setVisibility(View.GONE);
           ...
           /* getRawDataForApplicantSection(Arrays.asList(APPLICANT_TAB_SCREEN_NUMBERS_IL),
            ...
            if(loanType.equalsIgnoreCase(LOAN_NAME_EL)){
                getRawDataForLoanProposalSection(Arrays.asList(LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NUMBERS_IL),
                        Arrays.asList(LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NAMES_EL), CLIENT_ID, loanType, MODULE_TYPE_LOAN_PROPOSAL_WITH_NOMINEE);

            }else {
                getRawDataForLoanProposalSection(Arrays.asList(LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NUMBERS_IL),
                        Arrays.asList(LOAN_PROPOSAL_WITH_NOMINEE_MODULE_SCREEN_NAMES_PHL), CLIENT_ID, loanType, MODULE_TYPE_LOAN_PROPOSAL_WITH_NOMINEE);
            }
        }
        if (!TextUtils.isEmpty(loanType) && loanType.equalsIgnoreCase(LOAN_NAME_PHL)||loanType.equalsIgnoreCase(LOAN_NAME_EL)||loanType.equalsIgnoreCase(LOAN_NAME_TWL)) {
                            ...
                            appHelper.getDialogHelper().getConfirmationDialog().showTwoButtons(
                                    ...
                                    new ConfirmationDialog.ActionCallback() {
                                        ...
                                        public void onAction() {
                                            ...
                                            ibCoApplicant.putExtra(PARAM_CURRENT_STAGE, currentStage);
                                            ibCoApplicant.putExtra(PARAM_CURRENT_STAGE_ID, currentStageID);
