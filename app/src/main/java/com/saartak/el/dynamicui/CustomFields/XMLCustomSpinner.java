...
import static com.saartak.el.constants.AppConstant.SCREEN_NAME_APPLICANT_REGULATORY_FIELDS;
import static com.saartak.el.constants.AppConstant.SCREEN_NAME_CO_APPLICANT_REGULATORY_FIELDS;
import static com.saartak.el.constants.AppConstant.SCREEN_NO_APPLICANT_REGULATORY_FIELDS;
import static com.saartak.el.constants.AppConstant.SCREEN_NO_CO_APPLICANT_REGULATORY_FIELDS;
...
//            SearchableSpinner searchableSpinner=new SearchableSpinner(this.context);
            ...
            if ((params.getScreenName().equalsIgnoreCase(SCREEN_NAME_APPLICANT_REGULATORY_FIELDS)
                    || params.getScreenID().equalsIgnoreCase(SCREEN_NO_APPLICANT_REGULATORY_FIELDS))) {
                setSelection(getArrayAdapter().getPosition("No"));
            }

//
            if ((params.getScreenName().equalsIgnoreCase(SCREEN_NAME_CO_APPLICANT_REGULATORY_FIELDS)
                    || params.getScreenID().equalsIgnoreCase(SCREEN_NO_CO_APPLICANT_REGULATORY_FIELDS))) {
                setSelection(getArrayAdapter().getPosition("No"));
            }
